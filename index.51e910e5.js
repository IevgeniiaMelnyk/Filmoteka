 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt{static empty(){return new Wt(new qt(null))}constructor(e){this.writeTree_=e}}function zt(e,t,n){if(Ee(t))return new Wt(new qt(n));{const r=e.writeTree_.findRootMostValueAndPath(t);if(null!=r){const i=r.path;let s=r.value;const o=Ie(i,t);return s=s.updateChild(o,n),new Wt(e.writeTree_.set(i,s))}{const r=new qt(n),i=e.writeTree_.setTree(t,r);return new Wt(i)}}}function Vt(e,t,n){let r=e;return U(n,((e,n)=>{r=zt(r,be(t,e),n)})),r}function Ht(e,t){if(Ee(t))return Wt.empty();{const n=e.writeTree_.setTree(t,new qt(null));return new Wt(n)}}function $t(e,t){return null!=Kt(e,t)}function Kt(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Ie(n.path,t)):null}function Gt(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Je,((e,n)=>{t.push(new Oe(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new Oe(e,n.value))})),t}function Jt(e,t){if(Ee(t))return e;{const n=Kt(e,t);return new Wt(null!=n?new qt(n):e.writeTree_.subtree(t))}}function Yt(e){return e.writeTree_.isEmpty()}function Qt(e,t){return Xt(pe(),e.writeTree_,t)}function Xt(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let r=null;return t.children.inorderTraversal(((t,i)=>{".priority"===t?((0,o.assert)(null!==i.value,"Priority writes must always be leaf nodes"),r=i.value):n=Xt(be(e,t),i,n)})),n.getChild(e).isEmpty()||null===r||(n=n.updateChild(be(e,".priority"),r)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
