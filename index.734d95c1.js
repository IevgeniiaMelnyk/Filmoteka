 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eo(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}async function to(e,t,n,r,i={}){return no(e,i,(async()=>{let i={},s={};r&&("GET"===t?s=r:i={body:JSON.stringify(r)});const o=Ei(Object.assign({key:e.config.apiKey},s)).slice(1),a=await e._getAdditionalHeaders();return a["Content-Type"]="application/json",e.languageCode&&(a["X-Firebase-Locale"]=e.languageCode),Qs.fetch()(io(e,e.config.apiHost,n,o),Object.assign({method:t,headers:a,referrerPolicy:"no-referrer"},i))}))}async function no(e,t,n){e._canInitEmulator=!1;const r=Object.assign(Object.assign({},Xs),t);try{const t=new so(e),i=await Promise.race([n(),t.promise]);t.clearNetworkTimeout();const s=await i.json();if("needConfirmation"in s)throw oo(e,"account-exists-with-different-credential",s);if(i.ok&&!("errorMessage"in s))return s;{const t=i.ok?s.errorMessage:s.error.message,[n,o]=t.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===n)throw oo(e,"credential-already-in-use",s);if("EMAIL_EXISTS"===n)throw oo(e,"email-already-in-use",s);if("USER_DISABLED"===n)throw oo(e,"user-disabled",s);const a=r[n]||n.toLowerCase().replace(/[_\s]+/g,"-");if(o)throw Us(e,a,o);Ms(e,a)}}catch(t){if(t instanceof li)throw t;Ms(e,"network-request-failed")}}async function ro(e,t,n,r,i={}){const s=await to(e,t,n,r,i);return"mfaPendingCredential"in s&&Ms(e,"multi-factor-auth-required",{_serverResponse:s}),s}function io(e,t,n,r){const i=`${t}${n}?${r}`;return e.config.emulator?Ys(e.config,i):`${e.config.apiScheme}://${i}`}class so{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(Fs(this.auth,"network-request-failed"))),Zs.get())}))}}function oo(e,t,n){const r={appName:e.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const i=Fs(e,t,r);return i.customData._tokenResponse=n,i}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var i,s;r.setAttribute("src",e),r.onload=t,r.onerror=e=>{const t=Fs("internal-error");t.customData=e,n(t)},r.type="text/javascript",r.charset="UTF-8",(null!==(s=null===(i=document.getElementsByTagName("head"))||void 0===i?void 0:i[0])&&void 0!==s?s:document).appendChild(r)}))}function xa(e){return`__${e}${Math.floor(1e6*Math.random())}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qa{execute(){return new Promise((async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(e){this.reject(e)}}))}async onAuthEvent(e){const{urlResponse:t,sessionId:n,postBody:r,tenantId:i,error:s,type:o}=e;if(s)return void this.reject(s);const a={auth:this.auth,requestUri:t,sessionId:n,tenantId:i||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(o)(a))}catch(e){this.reject(e)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Fa;case"linkViaPopup":case"linkViaRedirect":return Ba;case"reauthViaPopup":case"reauthViaRedirect":return Ua;default:Ms(this.auth,"internal-error")}}resolve(e){Ws(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Ws(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}constructor(e,t,n,r,i=!1){this.auth=e,this.resolver=n,this.user=r,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nc=new Js(3e4,6e4);function rc(){const e=Ia().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let ic=null;function sc(e){return ic=ic||function(e){return new Promise(((t,n)=>{var r,i,s;function o(){rc(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{rc(),n(Fs(e,"network-request-failed"))},timeout:nc.get()})}if(null===(i=null===(r=Ia().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=Ia().gapi)||void 0===s?void 0:s.load)){const t=xa("iframefcb");return Ia()[t]=()=>{gapi.load?o():n(Fs(e,"network-request-failed"))},Oa(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw ic=null,e}))}(e),ic}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ic{set(e,t){null==t?delete this.cache_[e]:this.cache_[e]=t}get(e){return _i(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}constructor(){this.cache_={},this.isInMemoryStorage=!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ec=function(e){try{if("undefined"!=typeof window&&void 0!==window[e]){const t=window[e];return t.setItem("firebase:sentinel","cache"),t.removeItem("firebase:sentinel"),new bc(t)}}catch(e){}return new Ic},Cc=Ec("localStorage"),Tc=Ec("sessionStorage"),Sc=new zi("@firebase/database"),kc=function(){let e=1;return function(){return e++}}(),Rc=function(e){const t=Oi(e),n=new Si;n.update(t);const r=n.digest();return Hr.encodeByteArray(r)},Pc=function(...e){let t="";for(let n=0;n<e.length;n++){const r=e[n];Array.isArray(r)||r&&"object"==typeof r&&"number"==typeof r.length?t+=Pc.apply(null,r):t+="object"==typeof r?fi(r):r,t+=" "}return t};let Nc=null,Oc=!0;const xc=function(e,t){qr(!t||!0===e||!1===e,"Can't turn on custom loggers persistently."),!0===e?(Sc.logLevel=Ui.VERBOSE,Nc=Sc.log.bind(Sc),t&&Tc.set("logging_enabled",!0)):"function"==typeof e?Nc=e:(Nc=null,Tc.remove("logging_enabled"))},Ac=function(...e){if(!0===Oc&&(Oc=!1,null===Nc&&!0===Tc.get("logging_enabled")&&xc(!0)),Nc){const t=Pc.apply(null,e);Nc(t)}},Lc=function(e){return function(...t){Ac(e,...t)}},Dc=function(...e){const t="FIREBASE INTERNAL ERROR: "+Pc(...e);Sc.error(t)},Mc=function(...e){const t=`FIREBASE FATAL ERROR: ${Pc(...e)}`;throw Sc.error(t),new Error(t)},Fc=function(...e){const t="FIREBASE WARNING: "+Pc(...e);Sc.warn(t)},Uc=function(e){return"number"==typeof e&&(e!=e||e===Number.POSITIVE_INFINITY||e===Number.NEGATIVE_INFINITY)},Bc=function(e,t){if(e===t)return 0;if("[MIN_NAME]"===e||"[MAX_NAME]"===t)return-1;if("[MIN_NAME]"===t||"[MAX_NAME]"===e)return 1;{const n=Kc(e),r=Kc(t);return null!==n?null!==r?n-r==0?e.length-t.length:n-r:-1:null!==r?1:e<t?-1:1}},qc=function(e,t){return e===t?0:e<t?-1:1},jc=function(e,t){if(t&&e in t)return t[e];throw new Error("Missing required key ("+e+") in object: "+fi(t))},Wc=function(e){if("object"!=typeof e||null===e)return fi(e);const t=[];for(const n in e)t.push(n);t.sort();let n="{";for(let r=0;r<t.length;r++)0!==r&&(n+=","),n+=fi(t[r]),n+=":",n+=Wc(e[t[r]]);return n+="}",n},Hc=function(e,t){const n=e.length;if(n<=t)return[e];const r=[];for(let i=0;i<n;i+=t)i+t>n?r.push(e.substring(i,n)):r.push(e.substring(i,i+t));return r};function zc(e,t){for(const n in e)e.hasOwnProperty(n)&&t(n,e[n])}const $c=function(e){qr(!Uc(e),"Invalid JSON number");const t=1023;let n,r,i,s,o;0===e?(r=0,i=0,n=1/e==-1/0?1:0):(n=e<0,(e=Math.abs(e))>=Math.pow(2,-1022)?(s=Math.min(Math.floor(Math.log(e)/Math.LN2),t),r=s+t,i=Math.round(e*Math.pow(2,52-s)-Math.pow(2,52))):(r=0,i=Math.round(e/Math.pow(2,-1074))));const a=[];for(o=52;o;o-=1)a.push(i%2?1:0),i=Math.floor(i/2);for(o=11;o;o-=1)a.push(r%2?1:0),r=Math.floor(r/2);a.push(n?1:0),a.reverse();const c=a.join("");let l="";for(o=0;o<64;o+=8){let e=parseInt(c.substr(o,8),2).toString(16);1===e.length&&(e="0"+e),l+=e}return l.toLowerCase()};const Vc=new RegExp("^-?(0*)\\d{1,10}$"),Kc=function(e){if(Vc.test(e)){const t=Number(e);if(t>=-2147483648&&t<=2147483647)return t}return null},Gc=function(e){try{e()}catch(e){setTimeout((()=>{const t=e.stack||"";throw Fc("Exception was thrown by user callback.",t),e}),Math.floor(0))}},Jc=function(e,t){const n=setTimeout(e,t);return"number"==typeof n&&"undefined"!=typeof Deno&&Deno.unrefTimer?Deno.unrefTimer(n):"object"==typeof n&&n.unref&&n.unref(),n};
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qc{getToken(e){return this.auth_?this.auth_.getToken(e).catch((e=>e&&"auth/token-not-initialized"===e.code?(Ac("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(e))):new Promise(((t,n)=>{setTimeout((()=>{this.auth_?this.getToken(e).then(t,n):t(null)}),0)}))}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then((t=>t.addAuthTokenListener(e)))}removeTokenChangeListener(e){this.authProvider_.get().then((t=>t.removeAuthTokenListener(e)))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',Fc(e)}constructor(e,t,n){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=n,this.auth_=null,this.auth_=n.getImmediate({optional:!0}),this.auth_||n.onInit((e=>this.auth_=e))}}class Xc{getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}constructor(e){this.accessToken=e}}Xc.OWNER="owner";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Zc=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class el{isCacheableHost(){return"s-"===this.internalHost.substr(0,2)}isCustomHost(){return"firebaseio.com"!==this._domain&&"firebaseio-demo.com"!==this._domain}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&Cc.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){const e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}constructor(e,t,n,r,i=!1,s="",o=!1){this.secure=t,this.namespace=n,this.webSocketOnly=r,this.nodeAdmin=i,this.persistenceKey=s,this.includeNamespaceInQueryParams=o,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=Cc.get("host:"+e)||this._host}}function tl(e,t,n){let r;if(qr("string"==typeof t,"typeof type must == string"),qr("object"==typeof n,"typeof params must == object"),"websocket"===t)r=(e.secure?"wss://":"ws://")+e.internalHost+"/.ws?";else{if("long_polling"!==t)throw new Error("Unknown connection type: "+t);r=(e.secure?"https://":"http://")+e.internalHost+"/.lp?"}(function(e){return e.host!==e.internalHost||e.isCustomHost()||e.includeNamespaceInQueryParams})(e)&&(n.ns=e.namespace);const i=[];return zc(n,((e,t)=>{i.push(e+"="+t)})),r+i.join("&")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nl{incrementCounter(e,t=1){_i(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return Kr(this.counters_)}constructor(){this.counters_={}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rl={},il={};function sl(e){const t=e.toString();return rl[t]||(rl[t]=new nl),rl[t]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ol{closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const e=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let t=0;t<e.length;++t)e[t]&&Gc((()=>{this.onMessage_(e[t])}));if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class al{open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new ol(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout((()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null}),Math.floor(3e4)),function(e){if(ei()||"complete"===document.readyState)e();else{let t=!1;const n=function(){document.body?t||(t=!0,e()):setTimeout(n,Math.floor(10))};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",(()=>{"complete"===document.readyState&&n()})),window.attachEvent("onload",n))}}((()=>{if(this.isClosed_)return;this.scriptTagHolder=new cl(((...e)=>{const[t,n,r,i,s]=e;if(this.incrementIncomingBytes_(e),this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,"start"===t)this.id=n,this.password=r;else{if("close"!==t)throw new Error("Unrecognized command received: "+t);n?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(n,(()=>{this.onClosed_()}))):this.onClosed_()}}),((...e)=>{const[t,n]=e;this.incrementIncomingBytes_(e),this.myPacketOrderer.handleResponse(t,n)}),(()=>{this.onClosed_()}),this.urlFn);const e={start:"t"};e.ser=Math.floor(1e8*Math.random()),this.scriptTagHolder.uniqueCallbackIdentifier&&(e.cb=this.scriptTagHolder.uniqueCallbackIdentifier),e.v="5",this.transportSessionId&&(e.s=this.transportSessionId),this.lastSessionId&&(e.ls=this.lastSessionId),this.applicationId&&(e.p=this.applicationId),this.appCheckToken&&(e.ac=this.appCheckToken),"undefined"!=typeof location&&location.hostname&&Zc.test(location.hostname)&&(e.r="f");const t=this.urlFn(e);this.log_("Connecting via long-poll to "+t),this.scriptTagHolder.addTag(t,(()=>{}))}))}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){al.forceAllow_=!0}static forceDisallow(){al.forceDisallow_=!0}static isAvailable(){return!ei()&&(!!al.forceAllow_||!(al.forceDisallow_||"undefined"==typeof document||null==document.createElement||"object"==typeof window&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href)||"object"==typeof Windows&&"object"==typeof Windows.UI))}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=fi(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const n=zr(t),r=Hc(n,1840);for(let e=0;e<r.length;e++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,r.length,r[e]),this.curSegmentNum++}addDisconnectPingFrame(e,t){if(ei())return;this.myDisconnFrame=document.createElement("iframe");const n={dframe:"t"};n.id=e,n.pw=t,this.myDisconnFrame.src=this.urlFn(n),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=fi(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}constructor(e,t,n,r,i,s,o){this.connId=e,this.repoInfo=t,this.applicationId=n,this.appCheckToken=r,this.authToken=i,this.transportSessionId=s,this.lastSessionId=o,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=Lc(e),this.stats_=sl(t),this.urlFn=e=>(this.appCheckToken&&(e.ac=this.appCheckToken),tl(t,"long_polling",e))}}class cl{static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",!document.body)throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";document.body.appendChild(e);try{e.contentWindow.document||Ac("No IE domain setting required")}catch(t){const n=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+n+"';document.close();})())"}return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.innerHTML="",setTimeout((()=>{null!==this.myIFrame&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)}),Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e.id=this.myID,e.pw=this.myPW,e.ser=this.currentSerial;let t=this.urlFn(e),n="",r=0;for(;this.pendingSegs.length>0;){if(!(this.pendingSegs[0].d.length+30+n.length<=1870))break;{const e=this.pendingSegs.shift();n=n+"&seg"+r+"="+e.seg+"&ts"+r+"="+e.ts+"&d"+r+"="+e.d,r++}}return t+=n,this.addLongPollTag_(t,this.currentSerial),!0}return!1}enqueueSegment(e,t,n){this.pendingSegs.push({seg:e,ts:t,d:n}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const n=()=>{this.outstandingRequests.delete(t),this.newRequest_()},r=setTimeout(n,Math.floor(25e3));this.addTag(e,(()=>{clearTimeout(r),n()}))}addTag(e,t){ei()?this.doNodeLongPoll(e,t):setTimeout((()=>{try{if(!this.sendNewPolls)return;const n=this.myIFrame.doc.createElement("script");n.type="text/javascript",n.async=!0,n.src=e,n.onload=n.onreadystatechange=function(){const e=n.readyState;e&&"loaded"!==e&&"complete"!==e||(n.onload=n.onreadystatechange=null,n.parentNode&&n.parentNode.removeChild(n),t())},n.onerror=()=>{Ac("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(n)}catch(e){}}),Math.floor(1))}constructor(e,t,n,r){if(this.onDisconnect=n,this.urlFn=r,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(1e8*Math.random()),this.sendNewPolls=!0,ei())this.commandCB=e,this.onMessageCB=t;else{this.uniqueCallbackIdentifier=kc(),window["pLPCommand"+this.uniqueCallbackIdentifier]=e,window["pRTLPCB"+this.uniqueCallbackIdentifier]=t,this.myIFrame=cl.createIFrame_();let n="";if(this.myIFrame.src&&"javascript:"===this.myIFrame.src.substr(0,11)){n='<script>document.domain="'+document.domain+'";<\/script>'}const r="<html><body>"+n+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(r),this.myIFrame.doc.close()}catch(e){Ac("frame writing exception"),e.stack&&Ac(e.stack),Ac(e)}}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ll=null;"undefined"!=typeof MozWebSocket?ll=MozWebSocket:"undefined"!=typeof WebSocket&&(ll=WebSocket);class ul{static connectionURL_(e,t,n,r,i){const s={v:"5"};return!ei()&&"undefined"!=typeof location&&location.hostname&&Zc.test(location.hostname)&&(s.r="f"),t&&(s.s=t),n&&(s.ls=n),r&&(s.ac=r),i&&(s.p=i),tl(e,"websocket",s)}open(e,t){this.onDisconnect=t,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,Cc.set("previous_websocket_failure",!0);try{let e;if(ei()){const t=this.nodeAdmin?"AdminNode":"Node";e={headers:{"User-Agent":`Firebase/5/${wc}/${Ir.platform}/${t}`,"X-Firebase-GMPID":this.applicationId||""}},this.authToken&&(e.headers.Authorization=`Bearer ${this.authToken}`),this.appCheckToken&&(e.headers["X-Firebase-AppCheck"]=this.appCheckToken);const n={},r=0===this.connURL.indexOf("wss://")?n.HTTPS_PROXY||n.https_proxy:n.HTTP_PROXY||n.http_proxy;r&&(e.proxy={origin:r})}this.mySock=new ll(this.connURL,[],e)}catch(e){this.log_("Error instantiating WebSocket.");const t=e.message||e.data;return t&&this.log_(t),void this.onClosed_()}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=e=>{this.handleIncomingFrame(e)},this.mySock.onerror=e=>{this.log_("WebSocket error.  Closing connection.");const t=e.message||e.data;t&&this.log_(t),this.onClosed_()}}start(){}static forceDisallow(){ul.forceDisallow_=!0}static isAvailable(){let e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){const t=/Android ([0-9]{0,}\.[0-9]{0,})/,n=navigator.userAgent.match(t);n&&n.length>1&&parseFloat(n[1])<4.4&&(e=!0)}return!e&&null!==ll&&!ul.forceDisallow_}static previouslyFailed(){return Cc.isInMemoryStorage||!0===Cc.get("previous_websocket_failure")}markConnectionHealthy(){Cc.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const e=this.frames.join("");this.frames=null;const t=di(e);this.onMessage(t)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(qr(null===this.frames,"We already have a frame buffer"),e.length<=6){const t=Number(e);if(!isNaN(t))return this.handleNewFrameCount_(t),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(null===this.mySock)return;const t=e.data;if(this.bytesReceived+=t.length,this.stats_.incrementCounter("bytes_received",t.length),this.resetKeepAlive(),null!==this.frames)this.appendFrame_(t);else{const e=this.extractFrameCount_(t);null!==e&&this.appendFrame_(e)}}send(e){this.resetKeepAlive();const t=fi(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const n=Hc(t,16384);n.length>1&&this.sendString_(String(n.length));for(let e=0;e<n.length;e++)this.sendString_(n[e])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval((()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()}),Math.floor(45e3))}sendString_(e){try{this.mySock.send(e)}catch(e){this.log_("Exception thrown from WebSocket.send():",e.message||e.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}constructor(e,t,n,r,i,s,o){this.connId=e,this.applicationId=n,this.appCheckToken=r,this.authToken=i,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=Lc(this.connId),this.stats_=sl(t),this.connURL=ul.connectionURL_(t,s,o,r,n),this.nodeAdmin=t.nodeAdmin}}ul.responsesRequiredToBeHealthy=2,ul.healthyTimeout=3e4;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class hl{static get ALL_TRANSPORTS(){return[al,ul]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}initTransports_(e){const t=ul&&ul.isAvailable();let n=t&&!ul.previouslyFailed();if(e.webSocketOnly&&(t||Fc("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),n=!0),n)this.transports_=[ul];else{const e=this.transports_=[];for(const t of hl.ALL_TRANSPORTS)t&&t.isAvailable()&&e.push(t);hl.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}constructor(e){this.initTransports_(e)}}hl.globalTransportInitialized_=!1;class dl{start_(){const e=this.transportManager_.initialTransport();this.conn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,null,this.lastSessionId),this.primaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const t=this.connReceiver_(this.conn_),n=this.disconnReceiver_(this.conn_);this.tx_=this.conn_,this.rx_=this.conn_,this.secondaryConn_=null,this.isHealthy_=!1,setTimeout((()=>{this.conn_&&this.conn_.open(t,n)}),Math.floor(0));const r=e.healthyTimeout||0;r>0&&(this.healthyTimeout_=Jc((()=>{this.healthyTimeout_=null,this.isHealthy_||(this.conn_&&this.conn_.bytesReceived>102400?(this.log_("Connection exceeded healthy timeout but has received "+this.conn_.bytesReceived+" bytes.  Marking connection healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()):this.conn_&&this.conn_.bytesSent>10240?this.log_("Connection exceeded healthy timeout but has sent "+this.conn_.bytesSent+" bytes.  Leaving connection alive."):(this.log_("Closing unhealthy connection after timeout."),this.close()))}),Math.floor(r)))}nextTransportId_(){return"c:"+this.id+":"+this.connectionCount++}disconnReceiver_(e){return t=>{e===this.conn_?this.onConnectionLost_(t):e===this.secondaryConn_?(this.log_("Secondary connection lost."),this.onSecondaryConnectionLost_()):this.log_("closing an old connection")}}connReceiver_(e){return t=>{2!==this.state_&&(e===this.rx_?this.onPrimaryMessageReceived_(t):e===this.secondaryConn_?this.onSecondaryMessageReceived_(t):this.log_("message on old connection"))}}sendRequest(e){const t={t:"d",d:e};this.sendData_(t)}tryCleanupConnection(){this.tx_===this.secondaryConn_&&this.rx_===this.secondaryConn_&&(this.log_("cleaning up and promoting a connection: "+this.secondaryConn_.connId),this.conn_=this.secondaryConn_,this.secondaryConn_=null)}onSecondaryControl_(e){if("t"in e){const t=e.t;"a"===t?this.upgradeIfSecondaryHealthy_():"r"===t?(this.log_("Got a reset on secondary, closing it"),this.secondaryConn_.close(),this.tx_!==this.secondaryConn_&&this.rx_!==this.secondaryConn_||this.close()):"o"===t&&(this.log_("got pong on secondary."),this.secondaryResponsesRequired_--,this.upgradeIfSecondaryHealthy_())}}onSecondaryMessageReceived_(e){const t=jc("t",e),n=jc("d",e);if("c"===t)this.onSecondaryControl_(n);else{if("d"!==t)throw new Error("Unknown protocol layer: "+t);this.pendingDataMessages.push(n)}}upgradeIfSecondaryHealthy_(){this.secondaryResponsesRequired_<=0?(this.log_("Secondary connection is healthy."),this.isHealthy_=!0,this.secondaryConn_.markConnectionHealthy(),this.proceedWithUpgrade_()):(this.log_("sending ping on secondary."),this.secondaryConn_.send({t:"c",d:{t:"p",d:{}}}))}proceedWithUpgrade_(){this.secondaryConn_.start(),this.log_("sending client ack on secondary"),this.secondaryConn_.send({t:"c",d:{t:"a",d:{}}}),this.log_("Ending transmission on primary"),this.conn_.send({t:"c",d:{t:"n",d:{}}}),this.tx_=this.secondaryConn_,this.tryCleanupConnection()}onPrimaryMessageReceived_(e){const t=jc("t",e),n=jc("d",e);"c"===t?this.onControl_(n):"d"===t&&this.onDataMessage_(n)}onDataMessage_(e){this.onPrimaryResponse_(),this.onMessage_(e)}onPrimaryResponse_(){this.isHealthy_||(this.primaryResponsesRequired_--,this.primaryResponsesRequired_<=0&&(this.log_("Primary connection is healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()))}onControl_(e){const t=jc("t",e);if("d"in e){const n=e.d;if("h"===t)this.onHandshake_(n);else if("n"===t){this.log_("recvd end transmission on primary"),this.rx_=this.secondaryConn_;for(let e=0;e<this.pendingDataMessages.length;++e)this.onDataMessage_(this.pendingDataMessages[e]);this.pendingDataMessages=[],this.tryCleanupConnection()}else"s"===t?this.onConnectionShutdown_(n):"r"===t?this.onReset_(n):"e"===t?Dc("Server Error: "+n):"o"===t?(this.log_("got pong on primary."),this.onPrimaryResponse_(),this.sendPingOnPrimaryIfNecessary_()):Dc("Unknown control packet command: "+t)}}onHandshake_(e){const t=e.ts,n=e.v,r=e.h;this.sessionId=e.s,this.repoInfo_.host=r,0===this.state_&&(this.conn_.start(),this.onConnectionEstablished_(this.conn_,t),"5"!==n&&Fc("Protocol version mismatch detected"),this.tryStartUpgrade_())}tryStartUpgrade_(){const e=this.transportManager_.upgradeTransport();e&&this.startUpgrade_(e)}startUpgrade_(e){this.secondaryConn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,this.sessionId),this.secondaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const t=this.connReceiver_(this.secondaryConn_),n=this.disconnReceiver_(this.secondaryConn_);this.secondaryConn_.open(t,n),Jc((()=>{this.secondaryConn_&&(this.log_("Timed out trying to upgrade."),this.secondaryConn_.close())}),Math.floor(6e4))}onReset_(e){this.log_("Reset packet received.  New host: "+e),this.repoInfo_.host=e,1===this.state_?this.close():(this.closeConnections_(),this.start_())}onConnectionEstablished_(e,t){this.log_("Realtime connection established."),this.conn_=e,this.state_=1,this.onReady_&&(this.onReady_(t,this.sessionId),this.onReady_=null),0===this.primaryResponsesRequired_?(this.log_("Primary connection is healthy."),this.isHealthy_=!0):Jc((()=>{this.sendPingOnPrimaryIfNecessary_()}),Math.floor(5e3))}sendPingOnPrimaryIfNecessary_(){this.isHealthy_||1!==this.state_||(this.log_("sending ping on primary."),this.sendData_({t:"c",d:{t:"p",d:{}}}))}onSecondaryConnectionLost_(){const e=this.secondaryConn_;this.secondaryConn_=null,this.tx_!==e&&this.rx_!==e||this.close()}onConnectionLost_(e){this.conn_=null,e||0!==this.state_?1===this.state_&&this.log_("Realtime connection lost."):(this.log_("Realtime connection failed."),this.repoInfo_.isCacheableHost()&&(Cc.remove("host:"+this.repoInfo_.host),this.repoInfo_.internalHost=this.repoInfo_.host)),this.close()}onConnectionShutdown_(e){this.log_("Connection shutdown command received. Shutting down..."),this.onKill_&&(this.onKill_(e),this.onKill_=null),this.onDisconnect_=null,this.close()}sendData_(e){if(1!==this.state_)throw"Connection is not connected";this.tx_.send(e)}close(){2!==this.state_&&(this.log_("Closing realtime connection."),this.state_=2,this.closeConnections_(),this.onDisconnect_&&(this.onDisconnect_(),this.onDisconnect_=null))}closeConnections_(){this.log_("Shutting down all connections"),this.conn_&&(this.conn_.close(),this.conn_=null),this.secondaryConn_&&(this.secondaryConn_.close(),this.secondaryConn_=null),this.healthyTimeout_&&(clearTimeout(this.healthyTimeout_),this.healthyTimeout_=null)}constructor(e,t,n,r,i,s,o,a,c,l){this.id=e,this.repoInfo_=t,this.applicationId_=n,this.appCheckToken_=r,this.authToken_=i,this.onMessage_=s,this.onReady_=o,this.onDisconnect_=a,this.onKill_=c,this.lastSessionId=l,this.connectionCount=0,this.pendingDataMessages=[],this.state_=0,this.log_=Lc("c:"+this.id+":"),this.transportManager_=new hl(t),this.log_("Connection created"),this.start_()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fl{put(e,t,n,r){}merge(e,t,n,r){}refreshAuthToken(e){}refreshAppCheckToken(e){}onDisconnectPut(e,t,n){}onDisconnectMerge(e,t,n){}onDisconnectCancel(e,t){}reportStats(e){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pl{trigger(e,...t){if(Array.isArray(this.listeners_[e])){const n=[...this.listeners_[e]];for(let e=0;e<n.length;e++)n[e].callback.apply(n[e].context,t)}}on(e,t,n){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:t,context:n});const r=this.getInitialEvent(e);r&&t.apply(n,r)}off(e,t,n){this.validateEventType_(e);const r=this.listeners_[e]||[];for(let e=0;e<r.length;e++)if(r[e].callback===t&&(!n||n===r[e].context))return void r.splice(e,1)}validateEventType_(e){qr(this.allowedEvents_.find((t=>t===e)),"Unknown event: "+e)}constructor(e){this.allowedEvents_=e,this.listeners_={},qr(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gl extends pl{static getInstance(){return new gl}getInitialEvent(e){return qr("online"===e,"Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}constructor(){super(["online"]),this.online_=!0,"undefined"==typeof window||void 0===window.addEventListener||Yr()||(window.addEventListener("online",(()=>{this.online_||(this.online_=!0,this.trigger("online",!0))}),!1),window.addEventListener("offline",(()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))}),!1))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ml{toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)""!==this.pieces_[t]&&(e+="/"+this.pieces_[t]);return e||"/"}constructor(e,t){if(void 0===t){this.pieces_=e.split("/");let t=0;for(let e=0;e<this.pieces_.length;e++)this.pieces_[e].length>0&&(this.pieces_[t]=this.pieces_[e],t++);this.pieces_.length=t,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}}function _l(){return new ml("")}function yl(e){return e.pieceNum_>=e.pieces_.length?null:e.pieces_[e.pieceNum_]}function vl(e){return e.pieces_.length-e.pieceNum_}function wl(e){let t=e.pieceNum_;return t<e.pieces_.length&&t++,new ml(e.pieces_,t)}function bl(e){return e.pieceNum_<e.pieces_.length?e.pieces_[e.pieces_.length-1]:null}function Il(e,t=0){return e.pieces_.slice(e.pieceNum_+t)}function El(e){if(e.pieceNum_>=e.pieces_.length)return null;const t=[];for(let n=e.pieceNum_;n<e.pieces_.length-1;n++)t.push(e.pieces_[n]);return new ml(t,0)}function Cl(e,t){const n=[];for(let t=e.pieceNum_;t<e.pieces_.length;t++)n.push(e.pieces_[t]);if(t instanceof ml)for(let e=t.pieceNum_;e<t.pieces_.length;e++)n.push(t.pieces_[e]);else{const e=t.split("/");for(let t=0;t<e.length;t++)e[t].length>0&&n.push(e[t])}return new ml(n,0)}function Tl(e){return e.pieceNum_>=e.pieces_.length}function Sl(e,t){const n=yl(e),r=yl(t);if(null===n)return t;if(n===r)return Sl(wl(e),wl(t));throw new Error("INTERNAL ERROR: innerPath ("+t+") is not within outerPath ("+e+")")}function kl(e,t){if(vl(e)!==vl(t))return!1;for(let n=e.pieceNum_,r=t.pieceNum_;n<=e.pieces_.length;n++,r++)if(e.pieces_[n]!==t.pieces_[r])return!1;return!0}function Rl(e,t){let n=e.pieceNum_,r=t.pieceNum_;if(vl(e)>vl(t))return!1;for(;n<e.pieces_.length;){if(e.pieces_[n]!==t.pieces_[r])return!1;++n,++r}return!0}class Pl{constructor(e,t){this.errorPrefix_=t,this.parts_=Il(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let e=0;e<this.parts_.length;e++)this.byteLength_+=xi(this.parts_[e]);Nl(this)}}function Nl(e){if(e.byteLength_>768)throw new Error(e.errorPrefix_+"has a key path longer than 768 bytes ("+e.byteLength_+").");if(e.parts_.length>32)throw new Error(e.errorPrefix_+"path specified exceeds the maximum depth that can be written (32) or object contains a cycle "+Ol(e))}function Ol(e){return 0===e.parts_.length?"":"in property '"+e.parts_.join(".")+"'"}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xl extends pl{static getInstance(){return new xl}getInitialEvent(e){return qr("visible"===e,"Unknown event type: "+e),[this.visible_]}constructor(){let e,t;super(["visible"]),"undefined"!=typeof document&&void 0!==document.addEventListener&&(void 0!==document.hidden?(t="visibilitychange",e="hidden"):void 0!==document.mozHidden?(t="mozvisibilitychange",e="mozHidden"):void 0!==document.msHidden?(t="msvisibilitychange",e="msHidden"):void 0!==document.webkitHidden&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,(()=>{const t=!document[e];t!==this.visible_&&(this.visible_=t,this.trigger("visible",t))}),!1)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dl{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const n=new Ll("[MIN_NAME]",e),r=new Ll("[MIN_NAME]",t);return 0!==this.compare(n,r)}minPost(){return Ll.MIN}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ml;class Fl extends Dl{static get __EMPTY_NODE(){return Ml}static set __EMPTY_NODE(e){Ml=e}compare(e,t){return Bc(e.name,t.name)}isDefinedOn(e){throw jr("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Ll.MIN}maxPost(){return new Ll("[MAX_NAME]",Ml)}makePost(e,t){return qr("string"==typeof e,"KeyIndex indexValue must always be a string."),new Ll(e,Ml)}toString(){return".key"}}const Ul=new Fl;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bl{getNext(){if(0===this.nodeStack_.length)return null;let e,t=this.nodeStack_.pop();if(e=this.resultGenerator_?this.resultGenerator_(t.key,t.value):{key:t.key,value:t.value},this.isReverse_)for(t=t.left;!t.isEmpty();)this.nodeStack_.push(t),t=t.right;else for(t=t.right;!t.isEmpty();)this.nodeStack_.push(t),t=t.left;return e}hasNext(){return this.nodeStack_.length>0}peek(){if(0===this.nodeStack_.length)return null;const e=this.nodeStack_[this.nodeStack_.length-1];return this.resultGenerator_?this.resultGenerator_(e.key,e.value):{key:e.key,value:e.value}}constructor(e,t,n,r,i=null){this.isReverse_=r,this.resultGenerator_=i,this.nodeStack_=[];let s=1;for(;!e.isEmpty();)if(s=t?n(e.key,t):1,r&&(s*=-1),s<0)e=this.isReverse_?e.left:e.right;else{if(0===s){this.nodeStack_.push(e);break}this.nodeStack_.push(e),e=this.isReverse_?e.right:e.left}}}class ql{copy(e,t,n,r,i){return new ql(null!=e?e:this.key,null!=t?t:this.value,null!=n?n:this.color,null!=r?r:this.left,null!=i?i:this.right)}count(){return this.left.count()+1+this.right.count()}isEmpty(){return!1}inorderTraversal(e){return this.left.inorderTraversal(e)||!!e(this.key,this.value)||this.right.inorderTraversal(e)}reverseTraversal(e){return this.right.reverseTraversal(e)||e(this.key,this.value)||this.left.reverseTraversal(e)}min_(){return this.left.isEmpty()?this:this.left.min_()}minKey(){return this.min_().key}maxKey(){return this.right.isEmpty()?this.key:this.right.maxKey()}insert(e,t,n){let r=this;const i=n(e,r.key);return r=i<0?r.copy(null,null,null,r.left.insert(e,t,n),null):0===i?r.copy(null,t,null,null,null):r.copy(null,null,null,null,r.right.insert(e,t,n)),r.fixUp_()}removeMin_(){if(this.left.isEmpty())return jl.EMPTY_NODE;let e=this;return e.left.isRed_()||e.left.left.isRed_()||(e=e.moveRedLeft_()),e=e.copy(null,null,null,e.left.removeMin_(),null),e.fixUp_()}remove(e,t){let n,r;if(n=this,t(e,n.key)<0)n.left.isEmpty()||n.left.isRed_()||n.left.left.isRed_()||(n=n.moveRedLeft_()),n=n.copy(null,null,null,n.left.remove(e,t),null);else{if(n.left.isRed_()&&(n=n.rotateRight_()),n.right.isEmpty()||n.right.isRed_()||n.right.left.isRed_()||(n=n.moveRedRight_()),0===t(e,n.key)){if(n.right.isEmpty())return jl.EMPTY_NODE;r=n.right.min_(),n=n.copy(r.key,r.value,null,null,n.right.removeMin_())}n=n.copy(null,null,null,null,n.right.remove(e,t))}return n.fixUp_()}isRed_(){return this.color}fixUp_(){let e=this;return e.right.isRed_()&&!e.left.isRed_()&&(e=e.rotateLeft_()),e.left.isRed_()&&e.left.left.isRed_()&&(e=e.rotateRight_()),e.left.isRed_()&&e.right.isRed_()&&(e=e.colorFlip_()),e}moveRedLeft_(){let e=this.colorFlip_();return e.right.left.isRed_()&&(e=e.copy(null,null,null,null,e.right.rotateRight_()),e=e.rotateLeft_(),e=e.colorFlip_()),e}moveRedRight_(){let e=this.colorFlip_();return e.left.left.isRed_()&&(e=e.rotateRight_(),e=e.colorFlip_()),e}rotateLeft_(){const e=this.copy(null,null,ql.RED,null,this.right.left);return this.right.copy(null,null,this.color,e,null)}rotateRight_(){const e=this.copy(null,null,ql.RED,this.left.right,null);return this.left.copy(null,null,this.color,null,e)}colorFlip_(){const e=this.left.copy(null,null,!this.left.color,null,null),t=this.right.copy(null,null,!this.right.color,null,null);return this.copy(null,null,!this.color,e,t)}checkMaxDepth_(){const e=this.check_();return Math.pow(2,e)<=this.count()+1}check_(){if(this.isRed_()&&this.left.isRed_())throw new Error("Red node has red child("+this.key+","+this.value+")");if(this.right.isRed_())throw new Error("Right child of ("+this.key+","+this.value+") is red");const e=this.left.check_();if(e!==this.right.check_())throw new Error("Black depths differ");return e+(this.isRed_()?0:1)}constructor(e,t,n,r,i){this.key=e,this.value=t,this.color=null!=n?n:ql.RED,this.left=null!=r?r:jl.EMPTY_NODE,this.right=null!=i?i:jl.EMPTY_NODE}}ql.RED=!0,ql.BLACK=!1;class jl{insert(e,t){return new jl(this.comparator_,this.root_.insert(e,t,this.comparator_).copy(null,null,ql.BLACK,null,null))}remove(e){return new jl(this.comparator_,this.root_.remove(e,this.comparator_).copy(null,null,ql.BLACK,null,null))}get(e){let t,n=this.root_;for(;!n.isEmpty();){if(t=this.comparator_(e,n.key),0===t)return n.value;t<0?n=n.left:t>0&&(n=n.right)}return null}getPredecessorKey(e){let t,n=this.root_,r=null;for(;!n.isEmpty();){if(t=this.comparator_(e,n.key),0===t){if(n.left.isEmpty())return r?r.key:null;for(n=n.left;!n.right.isEmpty();)n=n.right;return n.key}t<0?n=n.left:t>0&&(r=n,n=n.right)}throw new Error("Attempted to find predecessor key for a nonexistent key.  What gives?")}isEmpty(){return this.root_.isEmpty()}count(){return this.root_.count()}minKey(){return this.root_.minKey()}maxKey(){return this.root_.maxKey()}inorderTraversal(e){return this.root_.inorderTraversal(e)}reverseTraversal(e){return this.root_.reverseTraversal(e)}getIterator(e){return new Bl(this.root_,null,this.comparator_,!1,e)}getIteratorFrom(e,t){return new Bl(this.root_,e,this.comparator_,!1,t)}getReverseIteratorFrom(e,t){return new Bl(this.root_,e,this.comparator_,!0,t)}getReverseIterator(e){return new Bl(this.root_,null,this.comparator_,!0,e)}constructor(e,t=jl.EMPTY_NODE){this.comparator_=e,this.root_=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Wl(e,t){return Bc(e.name,t.name)}function Hl(e,t){return Bc(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let zl;jl.EMPTY_NODE=new class{copy(e,t,n,r,i){return this}insert(e,t,n){return new ql(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const $l=function(e){return"number"==typeof e?"number:"+$c(e):"string:"+e},Vl=function(e){if(e.isLeafNode()){const t=e.val();qr("string"==typeof t||"number"==typeof t||"object"==typeof t&&_i(t,".sv"),"Priority must be a string or number.")}else qr(e===zl||e.isEmpty(),"priority of unexpected type.");qr(e===zl||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
let Kl,Gl,Jl;class Yl{static set __childrenNodeConstructor(e){Kl=e}static get __childrenNodeConstructor(){return Kl}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Yl(this.value_,e)}getImmediateChild(e){return".priority"===e?this.priorityNode_:Yl.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return Tl(e)?this:".priority"===yl(e)?this.priorityNode_:Yl.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return".priority"===e?this.updatePriority(t):t.isEmpty()&&".priority"!==e?this:Yl.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const n=yl(e);return null===n?t:t.isEmpty()&&".priority"!==n?this:(qr(".priority"!==n||1===vl(e),".priority must be the last token in a path"),this.updateImmediateChild(n,Yl.__childrenNodeConstructor.EMPTY_NODE.updateChild(wl(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(null===this.lazyHash_){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+$l(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",e+="number"===t?$c(this.value_):this.value_,this.lazyHash_=Rc(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Yl.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Yl.__childrenNodeConstructor?-1:(qr(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,n=typeof this.value_,r=Yl.VALUE_TYPE_ORDER.indexOf(t),i=Yl.VALUE_TYPE_ORDER.indexOf(n);return qr(r>=0,"Unknown leaf type: "+t),qr(i>=0,"Unknown leaf type: "+n),r===i?"object"===n?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:i-r}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}return!1}constructor(e,t=Yl.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,qr(void 0!==this.value_&&null!==this.value_,"LeafNode shouldn't be created with null/undefined value."),Vl(this.priorityNode_)}}Yl.VALUE_TYPE_ORDER=["object","boolean","number","string"];const Ql=new class extends Dl{compare(e,t){const n=e.node.getPriority(),r=t.node.getPriority(),i=n.compareTo(r);return 0===i?Bc(e.name,t.name):i}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return Ll.MIN}maxPost(){return new Ll("[MAX_NAME]",new Yl("[PRIORITY-POST]",Jl))}makePost(e,t){const n=Gl(e);return new Ll(t,new Yl("[PRIORITY-POST]",n))}toString(){return".priority"}},Xl=Math.log(2);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zl{nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}constructor(e){var t;this.count=(t=e+1,parseInt(Math.log(t)/Xl,10)),this.current_=this.count-1;const n=(r=this.count,parseInt(Array(r+1).join("1"),2));var r;this.bits_=e+1&n}}const eu=function(e,t,n,r){e.sort(t);const i=function(t,r){const s=r-t;let o,a;if(0===s)return null;if(1===s)return o=e[t],a=n?n(o):o,new ql(a,o.node,ql.BLACK,null,null);{const c=parseInt(s/2,10)+t,l=i(t,c),u=i(c+1,r);return o=e[c],a=n?n(o):o,new ql(a,o.node,ql.BLACK,l,u)}},s=function(t){let r=null,s=null,o=e.length;const a=function(t,r){const s=o-t,a=o;o-=t;const l=i(s+1,a),u=e[s],h=n?n(u):u;c(new ql(h,u.node,r,null,l))},c=function(e){r?(r.left=e,r=e):(s=e,r=e)};for(let e=0;e<t.count;++e){const n=t.nextBitIsOne(),r=Math.pow(2,t.count-(e+1));n?a(r,ql.BLACK):(a(r,ql.BLACK),a(r,ql.RED))}return s}(new Zl(e.length));return new jl(r||t,s)};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tu;const nu={};class ru{static get Default(){return qr(nu&&Ql,"ChildrenNode.ts has not been loaded"),tu=tu||new ru({".priority":nu},{".priority":Ql}),tu}get(e){const t=yi(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof jl?t:null}hasIndex(e){return _i(this.indexSet_,e.toString())}addIndex(e,t){qr(e!==Ul,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let r=!1;const i=t.getIterator(Ll.Wrap);let s,o=i.getNext();for(;o;)r=r||e.isDefinedOn(o.node),n.push(o),o=i.getNext();s=r?eu(n,e.getCompare()):nu;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const l=Object.assign({},this.indexes_);return l[a]=s,new ru(l,c)}addToIndexes(e,t){const n=wi(this.indexes_,((n,r)=>{const i=yi(this.indexSet_,r);if(qr(i,"Missing index implementation for "+r),n===nu){if(i.isDefinedOn(e.node)){const n=[],r=t.getIterator(Ll.Wrap);let s=r.getNext();for(;s;)s.name!==e.name&&n.push(s),s=r.getNext();return n.push(e),eu(n,i.getCompare())}return nu}{const r=t.get(e.name);let i=n;return r&&(i=i.remove(new Ll(e.name,r))),i.insert(e,e.node)}}));return new ru(n,this.indexSet_)}removeFromIndexes(e,t){const n=wi(this.indexes_,(n=>{if(n===nu)return n;{const r=t.get(e.name);return r?n.remove(new Ll(e.name,r)):n}}));return new ru(n,this.indexSet_)}constructor(e,t){this.indexes_=e,this.indexSet_=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let iu;class su{static get EMPTY_NODE(){return iu||(iu=new su(new jl(Hl),null,ru.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||iu}updatePriority(e){return this.children_.isEmpty()?this:new su(this.children_,e,this.indexMap_)}getImmediateChild(e){if(".priority"===e)return this.getPriority();{const t=this.children_.get(e);return null===t?iu:t}}getChild(e){const t=yl(e);return null===t?this:this.getImmediateChild(t).getChild(wl(e))}hasChild(e){return null!==this.children_.get(e)}updateImmediateChild(e,t){if(qr(t,"We should always be passing snapshot nodes"),".priority"===e)return this.updatePriority(t);{const n=new Ll(e,t);let r,i;t.isEmpty()?(r=this.children_.remove(e),i=this.indexMap_.removeFromIndexes(n,this.children_)):(r=this.children_.insert(e,t),i=this.indexMap_.addToIndexes(n,this.children_));const s=r.isEmpty()?iu:this.priorityNode_;return new su(r,s,i)}}updateChild(e,t){const n=yl(e);if(null===n)return t;{qr(".priority"!==yl(e)||1===vl(e),".priority must be the last token in a path");const r=this.getImmediateChild(n).updateChild(wl(e),t);return this.updateImmediateChild(n,r)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let n=0,r=0,i=!0;if(this.forEachChild(Ql,((s,o)=>{t[s]=o.val(e),n++,i&&su.INTEGER_REGEXP_.test(s)?r=Math.max(r,Number(s)):i=!1})),!e&&i&&r<2*n){const e=[];for(const n in t)e[n]=t[n];return e}return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(null===this.lazyHash_){let e="";this.getPriority().isEmpty()||(e+="priority:"+$l(this.getPriority().val())+":"),this.forEachChild(Ql,((t,n)=>{const r=n.hash();""!==r&&(e+=":"+t+":"+r)})),this.lazyHash_=""===e?"":Rc(e)}return this.lazyHash_}getPredecessorChildName(e,t,n){const r=this.resolveIndex_(n);if(r){const n=r.getPredecessorKey(new Ll(e,t));return n?n.name:null}return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.minKey();return e&&e.name}return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new Ll(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.maxKey();return e&&e.name}return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new Ll(t,this.children_.get(t)):null}forEachChild(e,t){const n=this.resolveIndex_(e);return n?n.inorderTraversal((e=>t(e.name,e.node))):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getIteratorFrom(e,(e=>e));{const n=this.children_.getIteratorFrom(e.name,Ll.Wrap);let r=n.peek();for(;null!=r&&t.compare(r,e)<0;)n.getNext(),r=n.peek();return n}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getReverseIteratorFrom(e,(e=>e));{const n=this.children_.getReverseIteratorFrom(e.name,Ll.Wrap);let r=n.peek();for(;null!=r&&t.compare(r,e)>0;)n.getNext(),r=n.peek();return n}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===ou?-1:0}withIndex(e){if(e===Ul||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new su(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===Ul||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority())){if(this.children_.count()===t.children_.count()){const e=this.getIterator(Ql),n=t.getIterator(Ql);let r=e.getNext(),i=n.getNext();for(;r&&i;){if(r.name!==i.name||!r.node.equals(i.node))return!1;r=e.getNext(),i=n.getNext()}return null===r&&null===i}return!1}return!1}}resolveIndex_(e){return e===Ul?null:this.indexMap_.get(e.toString())}constructor(e,t,n){this.children_=e,this.priorityNode_=t,this.indexMap_=n,this.lazyHash_=null,this.priorityNode_&&Vl(this.priorityNode_),this.children_.isEmpty()&&qr(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}}su.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;const ou=new class extends su{compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return su.EMPTY_NODE}isEmpty(){return!1}constructor(){super(new jl(Hl),su.EMPTY_NODE,ru.Default)}};Object.defineProperties(Ll,{MIN:{value:new Ll("[MIN_NAME]",su.EMPTY_NODE)},MAX:{value:new Ll("[MAX_NAME]",ou)}}),Fl.__EMPTY_NODE=su.EMPTY_NODE,Yl.__childrenNodeConstructor=su,zl=ou,function(e){Jl=e}(ou);function au(e,t=null){if(null===e)return su.EMPTY_NODE;if("object"==typeof e&&".priority"in e&&(t=e[".priority"]),qr(null===t||"string"==typeof t||"number"==typeof t||"object"==typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"==typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!=typeof e||".sv"in e){return new Yl(e,au(t))}if(e instanceof Array){let n=su.EMPTY_NODE;return zc(e,((t,r)=>{if(_i(e,t)&&"."!==t.substring(0,1)){const e=au(r);!e.isLeafNode()&&e.isEmpty()||(n=n.updateImmediateChild(t,e))}})),n.updatePriority(au(t))}{const n=[];let r=!1;if(zc(e,((e,t)=>{if("."!==e.substring(0,1)){const i=au(t);i.isEmpty()||(r=r||!i.getPriority().isEmpty(),n.push(new Ll(e,i)))}})),0===n.length)return su.EMPTY_NODE;const i=eu(n,Wl,(e=>e.name),Hl);if(r){const e=eu(n,Ql.getCompare());return new su(i,au(t),new ru({".priority":e},{".priority":Ql}))}return new su(i,au(t),ru.Default)}}!function(e){Gl=e}(au);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class cu extends Dl{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),r=this.extractChild(t.node),i=n.compareTo(r);return 0===i?Bc(e.name,t.name):i}makePost(e,t){const n=au(e),r=su.EMPTY_NODE.updateChild(this.indexPath_,n);return new Ll(t,r)}maxPost(){const e=su.EMPTY_NODE.updateChild(this.indexPath_,ou);return new Ll("[MAX_NAME]",e)}toString(){return Il(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,qr(!Tl(e)&&".priority"!==yl(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lu=new class extends Dl{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?Bc(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return Ll.MIN}maxPost(){return Ll.MAX}makePost(e,t){const n=au(e);return new Ll(t,n)}toString(){return".value"}};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uu(e){return{type:"value",snapshotNode:e}}function hu(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function du(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function fu(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class pu{updateChild(e,t,n,r,i,s){qr(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const o=e.getImmediateChild(t);return o.getChild(r).equals(n.getChild(r))&&o.isEmpty()===n.isEmpty()?e:(null!=s&&(n.isEmpty()?e.hasChild(t)?s.trackChildChange(du(t,o)):qr(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):o.isEmpty()?s.trackChildChange(hu(t,n)):s.trackChildChange(fu(t,n,o))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(Ql,((e,r)=>{t.hasChild(e)||n.trackChildChange(du(e,r))})),t.isLeafNode()||t.forEachChild(Ql,((t,r)=>{if(e.hasChild(t)){const i=e.getImmediateChild(t);i.equals(r)||n.trackChildChange(fu(t,r,i))}else n.trackChildChange(hu(t,r))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?su.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}constructor(e){this.index_=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gu{getStartPost(){return this.startPost_}getEndPost(){return this.endPost_}matches(e){const t=this.startIsInclusive_?this.index_.compare(this.getStartPost(),e)<=0:this.index_.compare(this.getStartPost(),e)<0,n=this.endIsInclusive_?this.index_.compare(e,this.getEndPost())<=0:this.index_.compare(e,this.getEndPost())<0;return t&&n}updateChild(e,t,n,r,i,s){return this.matches(new Ll(t,n))||(n=su.EMPTY_NODE),this.indexedFilter_.updateChild(e,t,n,r,i,s)}updateFullNode(e,t,n){t.isLeafNode()&&(t=su.EMPTY_NODE);let r=t.withIndex(this.index_);r=r.updatePriority(su.EMPTY_NODE);const i=this;return t.forEachChild(Ql,((e,t)=>{i.matches(new Ll(e,t))||(r=r.updateImmediateChild(e,su.EMPTY_NODE))})),this.indexedFilter_.updateFullNode(e,r,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.indexedFilter_}getIndex(){return this.index_}static getStartPost_(e){if(e.hasStart()){const t=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),t)}return e.getIndex().minPost()}static getEndPost_(e){if(e.hasEnd()){const t=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),t)}return e.getIndex().maxPost()}constructor(e){this.indexedFilter_=new pu(e.getIndex()),this.index_=e.getIndex(),this.startPost_=gu.getStartPost_(e),this.endPost_=gu.getEndPost_(e),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mu{updateChild(e,t,n,r,i,s){return this.rangedFilter_.matches(new Ll(t,n))||(n=su.EMPTY_NODE),e.getImmediateChild(t).equals(n)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,n,r,i,s):this.fullLimitUpdateChild_(e,t,n,i,s)}updateFullNode(e,t,n){let r;if(t.isLeafNode()||t.isEmpty())r=su.EMPTY_NODE.withIndex(this.index_);else if(2*this.limit_<t.numChildren()&&t.isIndexed(this.index_)){let e;r=su.EMPTY_NODE.withIndex(this.index_),e=this.reverse_?t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let n=0;for(;e.hasNext()&&n<this.limit_;){const t=e.getNext();if(this.withinDirectionalStart(t)){if(!this.withinDirectionalEnd(t))break;r=r.updateImmediateChild(t.name,t.node),n++}}}else{let e;r=t.withIndex(this.index_),r=r.updatePriority(su.EMPTY_NODE),e=this.reverse_?r.getReverseIterator(this.index_):r.getIterator(this.index_);let n=0;for(;e.hasNext();){const t=e.getNext();n<this.limit_&&this.withinDirectionalStart(t)&&this.withinDirectionalEnd(t)?n++:r=r.updateImmediateChild(t.name,su.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,r,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,t,n,r,i){let s;if(this.reverse_){const e=this.index_.getCompare();s=(t,n)=>e(n,t)}else s=this.index_.getCompare();const o=e;qr(o.numChildren()===this.limit_,"");const a=new Ll(t,n),c=this.reverse_?o.getFirstChild(this.index_):o.getLastChild(this.index_),l=this.rangedFilter_.matches(a);if(o.hasChild(t)){const e=o.getImmediateChild(t);let u=r.getChildAfterChild(this.index_,c,this.reverse_);for(;null!=u&&(u.name===t||o.hasChild(u.name));)u=r.getChildAfterChild(this.index_,u,this.reverse_);const h=null==u?1:s(u,a);if(l&&!n.isEmpty()&&h>=0)return null!=i&&i.trackChildChange(fu(t,n,e)),o.updateImmediateChild(t,n);{null!=i&&i.trackChildChange(du(t,e));const n=o.updateImmediateChild(t,su.EMPTY_NODE);return null!=u&&this.rangedFilter_.matches(u)?(null!=i&&i.trackChildChange(hu(u.name,u.node)),n.updateImmediateChild(u.name,u.node)):n}}return n.isEmpty()?e:l&&s(c,a)>=0?(null!=i&&(i.trackChildChange(du(c.name,c.node)),i.trackChildChange(hu(t,n))),o.updateImmediateChild(t,n).updateImmediateChild(c.name,su.EMPTY_NODE)):e}constructor(e){this.withinDirectionalStart=e=>this.reverse_?this.withinEndPost(e):this.withinStartPost(e),this.withinDirectionalEnd=e=>this.reverse_?this.withinStartPost(e):this.withinEndPost(e),this.withinStartPost=e=>{const t=this.index_.compare(this.rangedFilter_.getStartPost(),e);return this.startIsInclusive_?t<=0:t<0},this.withinEndPost=e=>{const t=this.index_.compare(e,this.rangedFilter_.getEndPost());return this.endIsInclusive_?t<=0:t<0},this.rangedFilter_=new gu(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft(),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _u{hasStart(){return this.startSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return qr(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return qr(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:"[MIN_NAME]"}hasEnd(){return this.endSet_}getIndexEndValue(){return qr(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return qr(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:"[MAX_NAME]"}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return qr(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===Ql}copy(){const e=new _u;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=Ql}}function yu(e){const t={};if(e.isDefault())return t;let n;if(e.index_===Ql?n="$priority":e.index_===lu?n="$value":e.index_===Ul?n="$key":(qr(e.index_ instanceof cu,"Unrecognized index type!"),n=e.index_.toString()),t.orderBy=fi(n),e.startSet_){const n=e.startAfterSet_?"startAfter":"startAt";t[n]=fi(e.indexStartValue_),e.startNameSet_&&(t[n]+=","+fi(e.indexStartName_))}if(e.endSet_){const n=e.endBeforeSet_?"endBefore":"endAt";t[n]=fi(e.indexEndValue_),e.endNameSet_&&(t[n]+=","+fi(e.indexEndName_))}return e.limitSet_&&(e.isViewFromLeft()?t.limitToFirst=e.limit_:t.limitToLast=e.limit_),t}function vu(e){const t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_),t.sin=!e.startAfterSet_),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_),t.ein=!e.endBeforeSet_),e.limitSet_){t.l=e.limit_;let n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==Ql&&(t.i=e.index_.toString()),t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wu extends fl{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(qr(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,r){const i=e._path.toString();this.log_("Listen called for "+i+" "+e._queryIdentifier);const s=wu.getListenId_(e,n),o={};this.listens_[s]=o;const a=yu(e._queryParams);this.restRequest_(i+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(i,a,!1,n),yi(this.listens_,s)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",r(t,null)}}))}unlisten(e,t){const n=wu.getListenId_(e,t);delete this.listens_[n]}get(e){const t=yu(e._queryParams),n=e._path.toString(),r=new ai;return this.restRequest_(n+".json",t,((e,t)=>{let i=t;404===e&&(i=null,e=null),null===e?(this.onDataUpdate_(n,i,!1,null),r.resolve(i)):r.reject(new Error(i))})),r.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([r,i])=>{r&&r.accessToken&&(t.auth=r.accessToken),i&&i.token&&(t.ac=i.token);const s=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+Ei(t);this.log_("Sending REST request for "+s);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+s+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=di(o.responseText)}catch(e){Fc("Failed to parse JSON response for "+s+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&Fc("Got unsuccessful REST response for "+s+" Status: "+o.status),n(o.status);n=null}},o.open("GET",s,!0),o.send()}))}constructor(e,t,n,r){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=r,this.log_=Lc("p:rest:"),this.listens_={}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bu{getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}constructor(){this.rootNode_=su.EMPTY_NODE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Iu(){return{value:null,children:new Map}}function Eu(e,t,n){if(Tl(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{const r=yl(t);e.children.has(r)||e.children.set(r,Iu());Eu(e.children.get(r),t=wl(t),n)}}function Cu(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach(((e,n)=>{t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,r)=>{Cu(r,new ml(t.toString()+"/"+e),n)}))}class Tu{get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&zc(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}constructor(e){this.collection_=e,this.last_=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Su{reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;zc(e,((e,r)=>{r>0&&_i(this.statsToReport_,e)&&(t[e]=r,n=!0)})),n&&this.server_.reportStats(t),Jc(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Tu(e);const n=1e4+2e4*Math.random();Jc(this.reportStats_.bind(this),Math.floor(n))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ku,Ru;function Pu(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Ru=ku||(ku={}))[Ru.OVERWRITE=0]="OVERWRITE",Ru[Ru.MERGE=1]="MERGE",Ru[Ru.ACK_USER_WRITE=2]="ACK_USER_WRITE",Ru[Ru.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class Nu{operationForChild(e){if(Tl(this.path)){if(null!=this.affectedTree.value)return qr(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new ml(e));return new Nu(_l(),t,this.revert)}}return qr(yl(this.path)===e,"operationForChild called for unrelated child."),new Nu(wl(this.path),this.affectedTree,this.revert)}constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=ku.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ou{operationForChild(e){return Tl(this.path)?new Ou(this.source,_l()):new Ou(this.source,wl(this.path))}constructor(e,t){this.source=e,this.path=t,this.type=ku.LISTEN_COMPLETE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xu{operationForChild(e){return Tl(this.path)?new xu(this.source,_l(),this.snap.getImmediateChild(e)):new xu(this.source,wl(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=ku.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Au{operationForChild(e){if(Tl(this.path)){const t=this.children.subtree(new ml(e));return t.isEmpty()?null:t.value?new xu(this.source,_l(),t.value):new Au(this.source,_l(),t)}return qr(yl(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Au(this.source,wl(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=ku.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lu{isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(e){if(Tl(e))return this.isFullyInitialized()&&!this.filtered_;const t=yl(e);return this.isCompleteForChild(t)}isCompleteForChild(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)}getNode(){return this.node_}constructor(e,t,n){this.node_=e,this.fullyInitialized_=t,this.filtered_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Du{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Mu(e,t,n,r,i,s){const o=r.filter((e=>e.type===n));o.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw jr("Should only compare child_ events.");const r=new Ll(t.childName,t.snapshotNode),i=new Ll(n.childName,n.snapshotNode);return e.index_.compare(r,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),o.forEach((n=>{const r=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,s);i.forEach((i=>{i.respondsTo(n.type)&&t.push(i.createEvent(r,e.query_))}))}))}function Fu(e,t){return{eventCache:e,serverCache:t}}function Uu(e,t,n,r){return Fu(new Lu(t,n,r),e.serverCache)}function Bu(e,t,n,r){return Fu(e.eventCache,new Lu(t,n,r))}function qu(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function ju(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Wu;class Hu{static fromObject(e){let t=new Hu(null);return zc(e,((e,n)=>{t=t.set(new ml(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:_l(),value:this.value};if(Tl(e))return null;{const n=yl(e),r=this.children.get(n);if(null!==r){const i=r.findRootMostMatchingPathAndValue(wl(e),t);if(null!=i){return{path:Cl(new ml(n),i.path),value:i.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Tl(e))return this;{const t=yl(e),n=this.children.get(t);return null!==n?n.subtree(wl(e)):new Hu(null)}}set(e,t){if(Tl(e))return new Hu(t,this.children);{const n=yl(e),r=(this.children.get(n)||new Hu(null)).set(wl(e),t),i=this.children.insert(n,r);return new Hu(this.value,i)}}remove(e){if(Tl(e))return this.children.isEmpty()?new Hu(null):new Hu(null,this.children);{const t=yl(e),n=this.children.get(t);if(n){const r=n.remove(wl(e));let i;return i=r.isEmpty()?this.children.remove(t):this.children.insert(t,r),null===this.value&&i.isEmpty()?new Hu(null):new Hu(this.value,i)}return this}}get(e){if(Tl(e))return this.value;{const t=yl(e),n=this.children.get(t);return n?n.get(wl(e)):null}}setTree(e,t){if(Tl(e))return t;{const n=yl(e),r=(this.children.get(n)||new Hu(null)).setTree(wl(e),t);let i;return i=r.isEmpty()?this.children.remove(n):this.children.insert(n,r),new Hu(this.value,i)}}fold(e){return this.fold_(_l(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((r,i)=>{n[r]=i.fold_(Cl(e,r),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,_l(),t)}findOnPath_(e,t,n){const r=!!this.value&&n(t,this.value);if(r)return r;if(Tl(e))return null;{const r=yl(e),i=this.children.get(r);return i?i.findOnPath_(wl(e),Cl(t,r),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,_l(),t)}foreachOnPath_(e,t,n){if(Tl(e))return this;{this.value&&n(t,this.value);const r=yl(e),i=this.children.get(r);return i?i.foreachOnPath_(wl(e),Cl(t,r),n):new Hu(null)}}foreach(e){this.foreach_(_l(),e)}foreach_(e,t){this.children.inorderTraversal(((n,r)=>{r.foreach_(Cl(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}constructor(e,t=(()=>(Wu||(Wu=new jl(qc)),Wu))()){this.value=e,this.children=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zu{static empty(){return new zu(new Hu(null))}constructor(e){this.writeTree_=e}}function $u(e,t,n){if(Tl(t))return new zu(new Hu(n));{const r=e.writeTree_.findRootMostValueAndPath(t);if(null!=r){const i=r.path;let s=r.value;const o=Sl(i,t);return s=s.updateChild(o,n),new zu(e.writeTree_.set(i,s))}{const r=new Hu(n),i=e.writeTree_.setTree(t,r);return new zu(i)}}}function Vu(e,t,n){let r=e;return zc(n,((e,n)=>{r=$u(r,Cl(t,e),n)})),r}function Ku(e,t){if(Tl(t))return zu.empty();{const n=e.writeTree_.setTree(t,new Hu(null));return new zu(n)}}function Gu(e,t){return null!=Ju(e,t)}function Ju(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Sl(n.path,t)):null}function Yu(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Ql,((e,n)=>{t.push(new Ll(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new Ll(e,n.value))})),t}function Qu(e,t){if(Tl(t))return e;{const n=Ju(e,t);return new zu(null!=n?new Hu(n):e.writeTree_.subtree(t))}}function Xu(e){return e.writeTree_.isEmpty()}function Zu(e,t){return eh(_l(),e.writeTree_,t)}function eh(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let r=null;return t.children.inorderTraversal(((t,i)=>{".priority"===t?(qr(null!==i.value,"Priority writes must always be leaf nodes"),r=i.value):n=eh(Cl(e,t),i,n)})),n.getChild(e).isEmpty()||null===r||(n=n.updateChild(Cl(e,".priority"),r)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function th(e,t){return ph(t,e)}function nh(e,t){const n=e.allWrites.findIndex((e=>e.writeId===t));qr(n>=0,"removeWrite called with nonexistent writeId.");const r=e.allWrites[n];e.allWrites.splice(n,1);let i=r.visible,s=!1,o=e.allWrites.length-1;for(;i&&o>=0;){const t=e.allWrites[o];t.visible&&(o>=n&&rh(t,r.path)?i=!1:Rl(r.path,t.path)&&(s=!0)),o--}if(i){if(s)return function(e){e.visibleWrites=sh(e.allWrites,ih,_l()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;if(r.snap)e.visibleWrites=Ku(e.visibleWrites,r.path);else{zc(r.children,(t=>{e.visibleWrites=Ku(e.visibleWrites,Cl(r.path,t))}))}return!0}return!1}function rh(e,t){if(e.snap)return Rl(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&Rl(Cl(e.path,n),t))return!0;return!1}function ih(e){return e.visible}function sh(e,t,n){let r=zu.empty();for(let i=0;i<e.length;++i){const s=e[i];if(t(s)){const e=s.path;let t;if(s.snap)Rl(n,e)?(t=Sl(n,e),r=$u(r,t,s.snap)):Rl(e,n)&&(t=Sl(e,n),r=$u(r,_l(),s.snap.getChild(t)));else{if(!s.children)throw jr("WriteRecord should have .snap or .children");if(Rl(n,e))t=Sl(n,e),r=Vu(r,t,s.children);else if(Rl(e,n))if(t=Sl(e,n),Tl(t))r=Vu(r,_l(),s.children);else{const e=yi(s.children,yl(t));if(e){const n=e.getChild(wl(t));r=$u(r,_l(),n)}}}}}return r}function oh(e,t,n,r,i){if(r||i){const s=Qu(e.visibleWrites,t);if(!i&&Xu(s))return n;if(i||null!=n||Gu(s,_l())){const s=function(e){return(e.visible||i)&&(!r||!~r.indexOf(e.writeId))&&(Rl(e.path,t)||Rl(t,e.path))};return Zu(sh(e.allWrites,s,t),n||su.EMPTY_NODE)}return null}{const r=Ju(e.visibleWrites,t);if(null!=r)return r;{const r=Qu(e.visibleWrites,t);if(Xu(r))return n;if(null!=n||Gu(r,_l())){return Zu(r,n||su.EMPTY_NODE)}return null}}}function ah(e,t,n,r){return oh(e.writeTree,e.treePath,t,n,r)}function ch(e,t){return function(e,t,n){let r=su.EMPTY_NODE;const i=Ju(e.visibleWrites,t);if(i)return i.isLeafNode()||i.forEachChild(Ql,((e,t)=>{r=r.updateImmediateChild(e,t)})),r;if(n){const i=Qu(e.visibleWrites,t);return n.forEachChild(Ql,((e,t)=>{const n=Zu(Qu(i,new ml(e)),t);r=r.updateImmediateChild(e,n)})),Yu(i).forEach((e=>{r=r.updateImmediateChild(e.name,e.node)})),r}return Yu(Qu(e.visibleWrites,t)).forEach((e=>{r=r.updateImmediateChild(e.name,e.node)})),r}(e.writeTree,e.treePath,t)}function lh(e,t,n,r){return function(e,t,n,r,i){qr(r||i,"Either existingEventSnap or existingServerSnap must exist");const s=Cl(t,n);if(Gu(e.visibleWrites,s))return null;{const t=Qu(e.visibleWrites,s);return Xu(t)?i.getChild(n):Zu(t,i.getChild(n))}}(e.writeTree,e.treePath,t,n,r)}function uh(e,t){return function(e,t){return Ju(e.visibleWrites,t)}(e.writeTree,Cl(e.treePath,t))}function hh(e,t,n,r,i,s){return function(e,t,n,r,i,s,o){let a;const c=Qu(e.visibleWrites,t),l=Ju(c,_l());if(null!=l)a=l;else{if(null==n)return[];a=Zu(c,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=o.getCompare(),n=s?a.getReverseIteratorFrom(r,o):a.getIteratorFrom(r,o);let c=n.getNext();for(;c&&e.length<i;)0!==t(c,r)&&e.push(c),c=n.getNext();return e}}(e.writeTree,e.treePath,t,n,r,i,s)}function dh(e,t,n){return function(e,t,n,r){const i=Cl(t,n),s=Ju(e.visibleWrites,i);if(null!=s)return s;if(r.isCompleteForChild(n))return Zu(Qu(e.visibleWrites,i),r.getNode().getImmediateChild(n));return null}(e.writeTree,e.treePath,t,n)}function fh(e,t){return ph(Cl(e.treePath,t),e.writeTree)}function ph(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gh{trackChildChange(e){const t=e.type,n=e.childName;qr("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),qr(".priority"!==n,"Only non-priority child changes can be tracked.");const r=this.changeMap.get(n);if(r){const i=r.type;if("child_added"===t&&"child_removed"===i)this.changeMap.set(n,fu(n,e.snapshotNode,r.snapshotNode));else if("child_removed"===t&&"child_added"===i)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===i)this.changeMap.set(n,du(n,r.oldSnap));else if("child_changed"===t&&"child_added"===i)this.changeMap.set(n,hu(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==i)throw jr("Illegal combination of changes: "+e+" occurred after "+r);this.changeMap.set(n,fu(n,e.snapshotNode,r.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}constructor(){this.changeMap=new Map}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mh=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class _h{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Lu(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return dh(this.writes_,e,t)}}getChildAfterChild(e,t,n){const r=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:ju(this.viewCache_),i=hh(this.writes_,r,t,1,n,e);return 0===i.length?null:i[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yh(e,t,n,r,i){const s=new gh;let o,a;if(n.type===ku.OVERWRITE){const c=n;c.source.fromUser?o=bh(e,t,c.path,c.snap,r,i,s):(qr(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!Tl(c.path),o=wh(e,t,c.path,c.snap,r,i,a,s))}else if(n.type===ku.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,r,i,s,o){let a=t;return r.foreach(((r,c)=>{const l=Cl(n,r);Ih(t,yl(l))&&(a=bh(e,a,l,c,i,s,o))})),r.foreach(((r,c)=>{const l=Cl(n,r);Ih(t,yl(l))||(a=bh(e,a,l,c,i,s,o))})),a}(e,t,c.path,c.children,r,i,s):(qr(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=Ch(e,t,c.path,c.children,r,i,a,s))}else if(n.type===ku.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,r,i,s){let o;if(null!=uh(r,n))return t;{const a=new _h(r,t,i),c=t.eventCache.getNode();let l;if(Tl(n)||".priority"===yl(n)){let n;if(t.serverCache.isFullyInitialized())n=ah(r,ju(t));else{const e=t.serverCache.getNode();qr(e instanceof su,"serverChildren would be complete if leaf node"),n=ch(r,e)}l=e.filter.updateFullNode(c,n,s)}else{const i=yl(n);let u=dh(r,i,t.serverCache);null==u&&t.serverCache.isCompleteForChild(i)&&(u=c.getImmediateChild(i)),l=null!=u?e.filter.updateChild(c,i,u,wl(n),a,s):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(c,i,su.EMPTY_NODE,wl(n),a,s):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=ah(r,ju(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=uh(r,_l()),Uu(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,a.path,r,i,s):function(e,t,n,r,i,s,o){if(null!=uh(i,n))return t;const a=t.serverCache.isFiltered(),c=t.serverCache;if(null!=r.value){if(Tl(n)&&c.isFullyInitialized()||c.isCompleteForPath(n))return wh(e,t,n,c.getNode().getChild(n),i,s,a,o);if(Tl(n)){let r=new Hu(null);return c.getNode().forEachChild(Ul,((e,t)=>{r=r.set(new ml(e),t)})),Ch(e,t,n,r,i,s,a,o)}return t}{let l=new Hu(null);return r.foreach(((e,t)=>{const r=Cl(n,e);c.isCompleteForPath(r)&&(l=l.set(e,c.getNode().getChild(r)))})),Ch(e,t,n,l,i,s,a,o)}}(e,t,a.path,a.affectedTree,r,i,s)}else{if(n.type!==ku.LISTEN_COMPLETE)throw jr("Unknown operation type: "+n.type);o=function(e,t,n,r,i){const s=t.serverCache,o=Bu(t,s.getNode(),s.isFullyInitialized()||Tl(n),s.isFiltered());return vh(e,o,n,r,mh,i)}(e,t,n.path,r,s)}const c=s.getChanges();return function(e,t,n){const r=t.eventCache;if(r.isFullyInitialized()){const i=r.getNode().isLeafNode()||r.getNode().isEmpty(),s=qu(e);(n.length>0||!e.eventCache.isFullyInitialized()||i&&!r.getNode().equals(s)||!r.getNode().getPriority().equals(s.getPriority()))&&n.push(uu(qu(t)))}}(t,o,c),{viewCache:o,changes:c}}function vh(e,t,n,r,i,s){const o=t.eventCache;if(null!=uh(r,n))return t;{let a,c;if(Tl(n))if(qr(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=ju(t),i=ch(r,n instanceof su?n:su.EMPTY_NODE);a=e.filter.updateFullNode(t.eventCache.getNode(),i,s)}else{const n=ah(r,ju(t));a=e.filter.updateFullNode(t.eventCache.getNode(),n,s)}else{const l=yl(n);if(".priority"===l){qr(1===vl(n),"Can't have a priority with additional path components");const i=o.getNode();c=t.serverCache.getNode();const s=lh(r,n,i,c);a=null!=s?e.filter.updatePriority(i,s):o.getNode()}else{const u=wl(n);let h;if(o.isCompleteForChild(l)){c=t.serverCache.getNode();const e=lh(r,n,o.getNode(),c);h=null!=e?o.getNode().getImmediateChild(l).updateChild(u,e):o.getNode().getImmediateChild(l)}else h=dh(r,l,t.serverCache);a=null!=h?e.filter.updateChild(o.getNode(),l,h,u,i,s):o.getNode()}}return Uu(t,a,o.isFullyInitialized()||Tl(n),e.filter.filtersNodes())}}function wh(e,t,n,r,i,s,o,a){const c=t.serverCache;let l;const u=o?e.filter:e.filter.getIndexedFilter();if(Tl(n))l=u.updateFullNode(c.getNode(),r,null);else if(u.filtersNodes()&&!c.isFiltered()){const e=c.getNode().updateChild(n,r);l=u.updateFullNode(c.getNode(),e,null)}else{const e=yl(n);if(!c.isCompleteForPath(n)&&vl(n)>1)return t;const i=wl(n),s=c.getNode().getImmediateChild(e).updateChild(i,r);l=".priority"===e?u.updatePriority(c.getNode(),s):u.updateChild(c.getNode(),e,s,i,mh,null)}const h=Bu(t,l,c.isFullyInitialized()||Tl(n),u.filtersNodes());return vh(e,h,n,i,new _h(i,h,s),a)}function bh(e,t,n,r,i,s,o){const a=t.eventCache;let c,l;const u=new _h(i,t,s);if(Tl(n))l=e.filter.updateFullNode(t.eventCache.getNode(),r,o),c=Uu(t,l,!0,e.filter.filtersNodes());else{const i=yl(n);if(".priority"===i)l=e.filter.updatePriority(t.eventCache.getNode(),r),c=Uu(t,l,a.isFullyInitialized(),a.isFiltered());else{const s=wl(n),l=a.getNode().getImmediateChild(i);let h;if(Tl(s))h=r;else{const e=u.getCompleteChild(i);h=null!=e?".priority"===bl(s)&&e.getChild(El(s)).isEmpty()?e:e.updateChild(s,r):su.EMPTY_NODE}if(l.equals(h))c=t;else{c=Uu(t,e.filter.updateChild(a.getNode(),i,h,s,u,o),a.isFullyInitialized(),e.filter.filtersNodes())}}}return c}function Ih(e,t){return e.eventCache.isCompleteForChild(t)}function Eh(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function Ch(e,t,n,r,i,s,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let c,l=t;c=Tl(n)?r:new Hu(null).setTree(n,r);const u=t.serverCache.getNode();return c.children.inorderTraversal(((n,r)=>{if(u.hasChild(n)){const c=Eh(0,t.serverCache.getNode().getImmediateChild(n),r);l=wh(e,l,new ml(n),c,i,s,o,a)}})),c.children.inorderTraversal(((n,r)=>{const c=!t.serverCache.isCompleteForChild(n)&&null===r.value;if(!u.hasChild(n)&&!c){const c=Eh(0,t.serverCache.getNode().getImmediateChild(n),r);l=wh(e,l,new ml(n),c,i,s,o,a)}})),l}class Th{get query(){return this.query_}constructor(e,t){this.query_=e,this.eventRegistrations_=[];const n=this.query_._queryParams,r=new pu(n.getIndex()),i=(s=n).loadsAllData()?new pu(s.getIndex()):s.hasLimit()?new mu(s):new gu(s);var s;this.processor_=function(e){return{filter:e}}(i);const o=t.serverCache,a=t.eventCache,c=r.updateFullNode(su.EMPTY_NODE,o.getNode(),null),l=i.updateFullNode(su.EMPTY_NODE,a.getNode(),null),u=new Lu(c,o.isFullyInitialized(),r.filtersNodes()),h=new Lu(l,a.isFullyInitialized(),i.filtersNodes());this.viewCache_=Fu(h,u),this.eventGenerator_=new Du(this.query_)}}function Sh(e,t){const n=ju(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!Tl(t)&&!n.getImmediateChild(yl(t)).isEmpty())?n.getChild(t):null}function kh(e){return 0===e.eventRegistrations_.length}function Rh(e,t,n){const r=[];if(n){qr(null==t,"A cancel should cancel all event registrations.");const i=e.query._path;e.eventRegistrations_.forEach((e=>{const t=e.createCancelEvent(n,i);t&&r.push(t)}))}if(t){let n=[];for(let r=0;r<e.eventRegistrations_.length;++r){const i=e.eventRegistrations_[r];if(i.matches(t)){if(t.hasAnyCallback()){n=n.concat(e.eventRegistrations_.slice(r+1));break}}else n.push(i)}e.eventRegistrations_=n}else e.eventRegistrations_=[];return r}function Ph(e,t,n,r){t.type===ku.MERGE&&null!==t.source.queryId&&(qr(ju(e.viewCache_),"We should always have a full cache before handling merges"),qr(qu(e.viewCache_),"Missing event cache, even though we have a server cache"));const i=e.viewCache_,s=yh(e.processor_,i,t,n,r);var o,a;return o=e.processor_,a=s.viewCache,qr(a.eventCache.getNode().isIndexed(o.filter.getIndex()),"Event snap not indexed"),qr(a.serverCache.getNode().isIndexed(o.filter.getIndex()),"Server snap not indexed"),qr(s.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=s.viewCache,Nh(e,s.changes,s.viewCache.eventCache.getNode(),null)}function Nh(e,t,n,r){const i=r?[r]:e.eventRegistrations_;return function(e,t,n,r){const i=[],s=[];return t.forEach((t=>{var n;"child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)&&s.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))})),Mu(e,i,"child_removed",t,r,n),Mu(e,i,"child_added",t,r,n),Mu(e,i,"child_moved",s,r,n),Mu(e,i,"child_changed",t,r,n),Mu(e,i,"value",t,r,n),i}(e.eventGenerator_,t,n,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Oh,xh;class Ah{constructor(){this.views=new Map}}function Lh(e,t,n,r){const i=t.source.queryId;if(null!==i){const s=e.views.get(i);return qr(null!=s,"SyncTree gave us an op for an invalid query."),Ph(s,t,n,r)}{let i=[];for(const s of e.views.values())i=i.concat(Ph(s,t,n,r));return i}}function Dh(e,t,n,r,i){const s=t._queryIdentifier,o=e.views.get(s);if(!o){let e=ah(n,i?r:null),s=!1;e?s=!0:r instanceof su?(e=ch(n,r),s=!1):(e=su.EMPTY_NODE,s=!1);const o=Fu(new Lu(e,s,!1),new Lu(r,i,!1));return new Th(t,o)}return o}function Mh(e,t,n,r,i,s){const o=Dh(e,t,r,i,s);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,o),function(e,t){e.eventRegistrations_.push(t)}(o,n),function(e,t){const n=e.viewCache_.eventCache,r=[];n.getNode().isLeafNode()||n.getNode().forEachChild(Ql,((e,t)=>{r.push(hu(e,t))}));return n.isFullyInitialized()&&r.push(uu(n.getNode())),Nh(e,r,n.getNode(),t)}(o,n)}function Fh(e,t,n,r){const i=t._queryIdentifier,s=[];let o=[];const a=Wh(e);if("default"===i)for(const[t,i]of e.views.entries())o=o.concat(Rh(i,n,r)),kh(i)&&(e.views.delete(t),i.query._queryParams.loadsAllData()||s.push(i.query));else{const t=e.views.get(i);t&&(o=o.concat(Rh(t,n,r)),kh(t)&&(e.views.delete(i),t.query._queryParams.loadsAllData()||s.push(t.query)))}return a&&!Wh(e)&&s.push(new(qr(Oh,"Reference.ts has not been loaded"),Oh)(t._repo,t._path)),{removed:s,events:o}}function Uh(e){const t=[];for(const n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function Bh(e,t){let n=null;for(const r of e.views.values())n=n||Sh(r,t);return n}function qh(e,t){if(t._queryParams.loadsAllData())return Hh(e);{const n=t._queryIdentifier;return e.views.get(n)}}function jh(e,t){return null!=qh(e,t)}function Wh(e){return null!=Hh(e)}function Hh(e){for(const t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let zh=1;class $h{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Hu(null),this.pendingWriteTree_={visibleWrites:zu.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Vh(e,t,n,r,i){return function(e,t,n,r,i){qr(r>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===i&&(i=!0),e.allWrites.push({path:t,snap:n,writeId:r,visible:i}),i&&(e.visibleWrites=$u(e.visibleWrites,t,n)),e.lastWriteId=r}(e.pendingWriteTree_,t,n,r,i),i?ed(e,new xu({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Kh(e,t,n=!1){const r=function(e,t){for(let n=0;n<e.allWrites.length;n++){const r=e.allWrites[n];if(r.writeId===t)return r}return null}(e.pendingWriteTree_,t);if(nh(e.pendingWriteTree_,t)){let t=new Hu(null);return null!=r.snap?t=t.set(_l(),!0):zc(r.children,(e=>{t=t.set(new ml(e),!0)})),ed(e,new Nu(r.path,t,n))}return[]}function Gh(e,t,n){return ed(e,new xu({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Jh(e,t,n,r,i=!1){const s=t._path,o=e.syncPointTree_.get(s);let a=[];if(o&&("default"===t._queryIdentifier||jh(o,t))){const c=Fh(o,t,n,r);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(s));const l=c.removed;if(a=c.events,!i){const n=-1!==l.findIndex((e=>e._queryParams.loadsAllData())),i=e.syncPointTree_.findOnPath(s,((e,t)=>Wh(t)));if(n&&!i){const t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&Wh(t)){return[Hh(t)]}{let e=[];return t&&(e=Uh(t)),zc(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const r=n[t],i=r.query,s=rd(e,r);e.listenProvider_.startListening(ld(i),id(e,i),s.hashFn,s.onComplete)}}}if(!i&&l.length>0&&!r)if(n){const n=null;e.listenProvider_.stopListening(ld(t),n)}else l.forEach((t=>{const n=e.queryToTagMap.get(sd(t));e.listenProvider_.stopListening(ld(t),n)}))}!function(e,t){for(let n=0;n<t.length;++n){const r=t[n];if(!r._queryParams.loadsAllData()){const t=sd(r),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,l)}return a}function Yh(e,t,n,r){const i=od(e,r);if(null!=i){const r=ad(i),s=r.path,o=r.queryId,a=Sl(s,t);return cd(e,s,new xu(Pu(o),a,n))}return[]}function Qh(e,t,n,r=!1){const i=t._path;let s=null,o=!1;e.syncPointTree_.foreachOnPath(i,((e,t)=>{const n=Sl(e,i);s=s||Bh(t,n),o=o||Wh(t)}));let a,c=e.syncPointTree_.get(i);if(c?(o=o||Wh(c),s=s||Bh(c,_l())):(c=new Ah,e.syncPointTree_=e.syncPointTree_.set(i,c)),null!=s)a=!0;else{a=!1,s=su.EMPTY_NODE;e.syncPointTree_.subtree(i).foreachChild(((e,t)=>{const n=Bh(t,_l());n&&(s=s.updateImmediateChild(e,n))}))}const l=jh(c,t);if(!l&&!t._queryParams.loadsAllData()){const n=sd(t);qr(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const r=zh++;e.queryToTagMap.set(n,r),e.tagToQueryMap.set(r,n)}let u=Mh(c,t,n,th(e.pendingWriteTree_,i),s,a);if(!l&&!o&&!r){const n=qh(c,t);u=u.concat(function(e,t,n){const r=t._path,i=id(e,t),s=rd(e,n),o=e.listenProvider_.startListening(ld(t),i,s.hashFn,s.onComplete),a=e.syncPointTree_.subtree(r);if(i)qr(!Wh(a.value),"If we're adding a query, it shouldn't be shadowed");else{const t=a.fold(((e,t,n)=>{if(!Tl(e)&&t&&Wh(t))return[Hh(t).query];{let e=[];return t&&(e=e.concat(Uh(t).map((e=>e.query)))),zc(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const r=t[n];e.listenProvider_.stopListening(ld(r),id(e,r))}}return o}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))}return u}function Xh(e,t,n){const r=e.pendingWriteTree_,i=e.syncPointTree_.findOnPath(t,((e,n)=>{const r=Bh(n,Sl(e,t));if(r)return r}));return oh(r,t,i,n,!0)}function Zh(e,t){const n=t._path;let r=null;e.syncPointTree_.foreachOnPath(n,((e,t)=>{const i=Sl(e,n);r=r||Bh(t,i)}));let i=e.syncPointTree_.get(n);i?r=r||Bh(i,_l()):(i=new Ah,e.syncPointTree_=e.syncPointTree_.set(n,i));const s=null!=r,o=s?new Lu(r,!0,!1):null;return function(e){return qu(e.viewCache_)}(Dh(i,t,th(e.pendingWriteTree_,t._path),s?o.getNode():su.EMPTY_NODE,s))}function ed(e,t){return td(t,e.syncPointTree_,null,th(e.pendingWriteTree_,_l()))}function td(e,t,n,r){if(Tl(e.path))return nd(e,t,n,r);{const i=t.get(_l());null==n&&null!=i&&(n=Bh(i,_l()));let s=[];const o=yl(e.path),a=e.operationForChild(o),c=t.children.get(o);if(c&&a){const e=n?n.getImmediateChild(o):null,t=fh(r,o);s=s.concat(td(a,c,e,t))}return i&&(s=s.concat(Lh(i,e,r,n))),s}}function nd(e,t,n,r){const i=t.get(_l());null==n&&null!=i&&(n=Bh(i,_l()));let s=[];return t.children.inorderTraversal(((t,i)=>{const o=n?n.getImmediateChild(t):null,a=fh(r,t),c=e.operationForChild(t);c&&(s=s.concat(nd(c,i,o,a)))})),i&&(s=s.concat(Lh(i,e,r,n))),s}function rd(e,t){const n=t.query,r=id(e,n);return{hashFn:()=>{const e=function(e){return e.viewCache_.serverCache.getNode()}(t)||su.EMPTY_NODE;return e.hash()},onComplete:t=>{if("ok"===t)return r?function(e,t,n){const r=od(e,n);if(r){const n=ad(r),i=n.path,s=n.queryId,o=Sl(i,t);return cd(e,i,new Ou(Pu(s),o))}return[]}(e,n._path,r):function(e,t){return ed(e,new Ou({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const r=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const r=new Error(e+" at "+t._path.toString()+": "+n);return r.code=e.toUpperCase(),r}(t,n);return Jh(e,n,null,r)}}}}function id(e,t){const n=sd(t);return e.queryToTagMap.get(n)}function sd(e){return e._path.toString()+"$"+e._queryIdentifier}function od(e,t){return e.tagToQueryMap.get(t)}function ad(e){const t=e.indexOf("$");return qr(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new ml(e.substr(0,t))}}function cd(e,t,n){const r=e.syncPointTree_.get(t);qr(r,"Missing sync point for query tag that we're tracking");return Lh(r,n,th(e.pendingWriteTree_,t),null)}function ld(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(qr(xh,"Reference.ts has not been loaded"),xh)(e._repo,e._path):e}class ud{getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new ud(t)}node(){return this.node_}constructor(e){this.node_=e}}class hd{getImmediateChild(e){const t=Cl(this.path_,e);return new hd(this.syncTree_,t)}node(){return Xh(this.syncTree_,this.path_)}constructor(e,t){this.syncTree_=e,this.path_=t}}const dd=function(e,t,n){return e&&"object"==typeof e?(qr(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?fd(e[".sv"],t,n):"object"==typeof e[".sv"]?pd(e[".sv"],t):void qr(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},fd=function(e,t,n){if("timestamp"===e)return n.timestamp;qr(!1,"Unexpected server value: "+e)},pd=function(e,t,n){e.hasOwnProperty("increment")||qr(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const r=e.increment;"number"!=typeof r&&qr(!1,"Unexpected increment value: "+r);const i=t.node();if(qr(null!=i,"Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return r;const s=i.getValue();return"number"!=typeof s?r:s+r},gd=function(e,t,n,r){return _d(t,new hd(n,e),r)},md=function(e,t,n){return _d(e,new ud(t),n)};function _d(e,t,n){const r=e.getPriority().val(),i=dd(r,t.getImmediateChild(".priority"),n);let s;if(e.isLeafNode()){const r=e,s=dd(r.getValue(),t,n);return s!==r.getValue()||i!==r.getPriority().val()?new Yl(s,au(i)):e}{const r=e;return s=r,i!==r.getPriority().val()&&(s=s.updatePriority(new Yl(i))),r.forEachChild(Ql,((e,r)=>{const i=_d(r,t.getImmediateChild(e),n);i!==r&&(s=s.updateImmediateChild(e,i))})),s}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yd{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function vd(e,t){let n=t instanceof ml?t:new ml(t),r=e,i=yl(n);for(;null!==i;){const e=yi(r.node.children,i)||{children:{},childCount:0};r=new yd(i,r,e),n=wl(n),i=yl(n)}return r}function wd(e){return e.node.value}function bd(e,t){e.node.value=t,Sd(e)}function Id(e){return e.node.childCount>0}function Ed(e,t){zc(e.node.children,((n,r)=>{t(new yd(n,e,r))}))}function Cd(e,t,n,r){n&&!r&&t(e),Ed(e,(e=>{Cd(e,t,!0,r)})),n&&r&&t(e)}function Td(e){return new ml(null===e.parent?e.name:Td(e.parent)+"/"+e.name)}function Sd(e){null!==e.parent&&function(e,t,n){const r=function(e){return void 0===wd(e)&&!Id(e)}(n),i=_i(e.node.children,t);r&&i?(delete e.node.children[t],e.node.childCount--,Sd(e)):r||i||(e.node.children[t]=n.node,e.node.childCount++,Sd(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const kd=/[\[\].#$\/\u0000-\u001F\u007F]/,Rd=/[\[\].#$\u0000-\u001F\u007F]/,Pd=function(e){return"string"==typeof e&&0!==e.length&&!kd.test(e)},Nd=function(e){return"string"==typeof e&&0!==e.length&&!Rd.test(e)},Od=function(e,t,n,r){r&&void 0===t||xd(Ni(e,"value"),t,n)},xd=function(e,t,n){const r=n instanceof ml?new Pl(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Ol(r));if("function"==typeof t)throw new Error(e+"contains a function "+Ol(r)+" with contents = "+t.toString());if(Uc(t))throw new Error(e+"contains "+t.toString()+" "+Ol(r));if("string"==typeof t&&t.length>10485760/3&&xi(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+Ol(r)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,i=!1;if(zc(t,((t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(i=!0,!Pd(t)))throw new Error(e+" contains an invalid key ("+t+") "+Ol(r)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=r).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=xi(a),Nl(o),xd(e,s,r),function(e){const t=e.parts_.pop();e.byteLength_-=xi(t),e.parts_.length>0&&(e.byteLength_-=1)}(r)})),n&&i)throw new Error(e+' contains ".value" child '+Ol(r)+" in addition to actual children.")}},Ad=function(e,t,n,r){if(!(r&&void 0===n||Nd(n)))throw new Error(Ni(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Ld=function(e,t){if(".info"===yl(t))throw new Error(e+" failed = Can't modify data under /.info/")},Dd=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!Pd(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Nd(e)}(n))throw new Error(Ni(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Md{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Fd(e,t){let n=null;for(let r=0;r<t.length;r++){const i=t[r],s=i.getPath();null===n||kl(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(i)}n&&e.eventLists_.push(n)}function Ud(e,t,n){Fd(e,n),Bd(e,(e=>Rl(e,t)||Rl(t,e)))}function Bd(e,t){e.recursionDepth_++;let n=!0;for(let r=0;r<e.eventLists_.length;r++){const i=e.eventLists_[r];if(i){t(i.path)?(qd(e.eventLists_[r]),e.eventLists_[r]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function qd(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const r=n.getEventRunner();Nc&&Ac("event: "+n.toString()),Gc(r)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jd{toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}constructor(e,t,n,r){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Md,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Iu(),this.transactionQueueTree_=new yd,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}}function Wd(e,t,n){if(e.stats_=sl(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new wu(e.repoInfo_,((t,n,r,i)=>{$d(e,t,n,r,i)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>Vd(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{fi(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new Al(e.repoInfo_,t,((t,n,r,i)=>{$d(e,t,n,r,i)}),(t=>{Vd(e,t)}),(t=>{!function(e,t){zc(t,((t,n)=>{Kd(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return il[n]||(il[n]=t()),il[n]}(e.repoInfo_,(()=>new Su(e.stats_,e.server_))),e.infoData_=new bu,e.infoSyncTree_=new $h({startListening:(t,n,r,i)=>{let s=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=Gh(e.infoSyncTree_,t._path,o),setTimeout((()=>{i("ok")}),0)),s},stopListening:()=>{}}),Kd(e,"connected",!1),e.serverSyncTree_=new $h({startListening:(t,n,r,i)=>(e.server_.listen(t,r,n,((n,r)=>{const s=i(n,r);Ud(e.eventQueue_,t._path,s)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function Hd(e){const t=e.infoData_.getNode(new ml(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function zd(e){return(t=(t={timestamp:Hd(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function $d(e,t,n,r,i){e.dataUpdateCount++;const s=new ml(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(i)if(r){const t=wi(n,(e=>au(e)));o=function(e,t,n,r){const i=od(e,r);if(i){const r=ad(i),s=r.path,o=r.queryId,a=Sl(s,t),c=Hu.fromObject(n);return cd(e,s,new Au(Pu(o),a,c))}return[]}(e.serverSyncTree_,s,t,i)}else{const t=au(n);o=Yh(e.serverSyncTree_,s,t,i)}else if(r){const t=wi(n,(e=>au(e)));o=function(e,t,n){const r=Hu.fromObject(n);return ed(e,new Au({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,r))}(e.serverSyncTree_,s,t)}else{const t=au(n);o=Gh(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=tf(e,s)),Ud(e.eventQueue_,a,o)}function Vd(e,t){Kd(e,"connected",t),!1===t&&function(e){Qd(e,"onDisconnectEvents");const t=zd(e),n=Iu();Cu(e.onDisconnect_,_l(),((r,i)=>{const s=gd(r,i,e.serverSyncTree_,t);Eu(n,r,s)}));let r=[];Cu(n,_l(),((t,n)=>{r=r.concat(Gh(e.serverSyncTree_,t,n));const i=af(e,t);tf(e,i)})),e.onDisconnect_=Iu(),Ud(e.eventQueue_,_l(),r)}(e)}function Kd(e,t,n){const r=new ml("/.info/"+t),i=au(n);e.infoData_.updateSnapshot(r,i);const s=Gh(e.infoSyncTree_,r,i);Ud(e.eventQueue_,r,s)}function Gd(e){return e.nextWriteId_++}function Jd(e,t,n,r,i){Qd(e,"set",{path:t.toString(),value:n,priority:r});const s=zd(e),o=au(n,r),a=Xh(e.serverSyncTree_,t),c=md(o,a,s),l=Gd(e),u=Vh(e.serverSyncTree_,t,c,l,!0);Fd(e.eventQueue_,u),e.server_.put(t.toString(),o.val(!0),((n,r)=>{const s="ok"===n;s||Fc("set at "+t+" failed: "+n);const o=Kh(e.serverSyncTree_,l,!s);Ud(e.eventQueue_,t,o),Xd(e,i,n,r)}));const h=af(e,t);tf(e,h),Ud(e.eventQueue_,h,[])}function Yd(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function Qd(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),Ac(n,...t)}function Xd(e,t,n,r){t&&Gc((()=>{if("ok"===n)t(null);else{const e=(n||"error").toUpperCase();let i=e;r&&(i+=": "+r);const s=new Error(i);s.code=e,t(s)}}))}function Zd(e,t,n){return Xh(e.serverSyncTree_,t,n)||su.EMPTY_NODE}function ef(e,t=e.transactionQueueTree_){if(t||of(e,t),wd(t)){const n=rf(e,t);qr(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const r=n.map((e=>e.currentWriteId)),i=Zd(e,t,r);let s=i;const o=i.hash();for(let e=0;e<n.length;e++){const r=n[e];qr(0===r.status,"tryToSendTransactionQueue_: items in queue should all be run."),r.status=1,r.retryCount++;const i=Sl(t,r.path);s=s.updateChild(i,r.currentOutputSnapshotRaw)}const a=s.val(!0),c=t;e.server_.put(c.toString(),a,(r=>{Qd(e,"transaction put response",{path:c.toString(),status:r});let i=[];if("ok"===r){const r=[];for(let t=0;t<n.length;t++)n[t].status=2,i=i.concat(Kh(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&r.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();of(e,vd(e.transactionQueueTree_,t)),ef(e,e.transactionQueueTree_),Ud(e.eventQueue_,t,i);for(let e=0;e<r.length;e++)Gc(r[e])}else{if("datastale"===r)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{Fc("transaction at "+c.toString()+" failed: "+r);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=r}tf(e,t)}}),o)}(e,Td(t),n)}else Id(t)&&Ed(t,(t=>{ef(e,t)}))}function tf(e,t){const n=nf(e,t),r=Td(n);return function(e,t,n){if(0===t.length)return;const r=[];let i=[];const s=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const c=t[a],l=Sl(n,c.path);let u,h=!1;if(qr(null!==l,"rerunTransactionsUnderNode_: relativePath should not be null."),4===c.status)h=!0,u=c.abortReason,i=i.concat(Kh(e.serverSyncTree_,c.currentWriteId,!0));else if(0===c.status)if(c.retryCount>=25)h=!0,u="maxretry",i=i.concat(Kh(e.serverSyncTree_,c.currentWriteId,!0));else{const n=Zd(e,c.path,s);c.currentInputSnapshot=n;const r=t[a].update(n.val());if(void 0!==r){xd("transaction failed: Data returned ",r,c.path);let t=au(r);"object"==typeof r&&null!=r&&_i(r,".priority")||(t=t.updatePriority(n.getPriority()));const o=c.currentWriteId,a=zd(e),l=md(t,n,a);c.currentOutputSnapshotRaw=t,c.currentOutputSnapshotResolved=l,c.currentWriteId=Gd(e),s.splice(s.indexOf(o),1),i=i.concat(Vh(e.serverSyncTree_,c.path,l,c.currentWriteId,c.applyLocally)),i=i.concat(Kh(e.serverSyncTree_,o,!0))}else h=!0,u="nodata",i=i.concat(Kh(e.serverSyncTree_,c.currentWriteId,!0))}Ud(e.eventQueue_,n,i),i=[],h&&(t[a].status=2,o=t[a].unwatcher,setTimeout(o,Math.floor(0)),t[a].onComplete&&("nodata"===u?r.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):r.push((()=>t[a].onComplete(new Error(u),!1,null)))))}var o;of(e,e.transactionQueueTree_);for(let e=0;e<r.length;e++)Gc(r[e]);ef(e,e.transactionQueueTree_)}(e,rf(e,n),r),r}function nf(e,t){let n,r=e.transactionQueueTree_;for(n=yl(t);null!==n&&void 0===wd(r);)r=vd(r,n),n=yl(t=wl(t));return r}function rf(e,t){const n=[];return sf(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function sf(e,t,n){const r=wd(t);if(r)for(let e=0;e<r.length;e++)n.push(r[e]);Ed(t,(t=>{sf(e,t,n)}))}function of(e,t){const n=wd(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,bd(t,n.length>0?n:void 0)}Ed(t,(t=>{of(e,t)}))}function af(e,t){const n=Td(nf(e,t)),r=vd(e.transactionQueueTree_,t);return function(e,t,n){let r=n?e:e.parent;for(;null!==r;){if(t(r))return!0;r=r.parent}}(r,(t=>{cf(e,t)})),cf(e,r),Cd(r,(t=>{cf(e,t)})),n}function cf(e,t){const n=wd(t);if(n){const r=[];let i=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(qr(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(qr(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),i=i.concat(Kh(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&r.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===s?bd(t,void 0):n.length=s+1,Ud(e.eventQueue_,Td(t),i);for(let e=0;e<r.length;e++)Gc(r[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ff{onValue(e,t){this.snapshotCallback.call(null,e,t)}onCancel(e){return qr(this.hasCancelCallback,"Raising a cancel event on a listener with no cancel callback"),this.cancelCallback.call(null,e)}get hasCancelCallback(){return!!this.cancelCallback}matches(e){return this.snapshotCallback===e.snapshotCallback||void 0!==this.snapshotCallback.userCallback&&this.snapshotCallback.userCallback===e.snapshotCallback.userCallback&&this.snapshotCallback.context===e.snapshotCallback.context}constructor(e,t){this.snapshotCallback=e,this.cancelCallback=t}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class pf{get key(){return Tl(this._path)?null:bl(this._path)}get ref(){return new gf(this._repo,this._path)}get _queryIdentifier(){const e=vu(this._queryParams),t=Wc(e);return"{}"===t?"default":t}get _queryObject(){return vu(this._queryParams)}isEqual(e){if(!((e=Ai(e))instanceof pf))return!1;const t=this._repo===e._repo,n=kl(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,r){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=r}}class gf extends pf{get parent(){const e=El(this._path);return null===e?null:new gf(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new _u,!1)}}class mf{get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new ml(e),n=yf(this.ref,e);return new mf(this._node.getChild(t),n,Ql)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new mf(n,yf(this.ref,t),Ql))))}hasChild(e){const t=new ml(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}constructor(e,t,n){this._node=e,this.ref=t,this._index=n}}function _f(e,t){return(e=Ai(e))._checkNotDeleted("ref"),void 0!==t?yf(e._root,t):e._root}function yf(e,t){var n,r,i,s;return null===yl((e=Ai(e))._path)?(n="child",r="path",s=!1,(i=t)&&(i=i.replace(/^\/*\.info(\/|$)/,"/")),Ad(n,r,i,s)):Ad("child","path",t,!1),new gf(e._repo,Cl(e._path,t))}function vf(e,t){e=Ai(e),Ld("set",e._path),Od("set",t,e._path,!1);const n=new ai;return Jd(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function wf(e){e=Ai(e);const t=new ff((()=>{})),n=new bf(t);return function(e,t,n){const r=Zh(e.serverSyncTree_,t);return null!=r?Promise.resolve(r):e.server_.get(t).then((r=>{const i=au(r).withIndex(t._queryParams.getIndex());let s;if(Qh(e.serverSyncTree_,t,n,!0),t._queryParams.loadsAllData())s=Gh(e.serverSyncTree_,t._path,i);else{const n=id(e.serverSyncTree_,t);s=Yh(e.serverSyncTree_,t._path,i,n)}return Ud(e.eventQueue_,t._path,s),Jh(e.serverSyncTree_,t,n,null,!0),i}),(n=>(Qd(e,"get for query "+fi(t)+" failed: "+n),Promise.reject(new Error(n)))))}(e._repo,e,n).then((t=>new mf(t,new gf(e._repo,e._path),e._queryParams.getIndex())))}class bf{respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new hf("value",this,new mf(e.snapshotNode,new gf(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new df(this,e,t):null}matches(e){return e instanceof bf&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}constructor(e){this.callbackContext=e}}!function(e){qr(!Oh,"__referenceConstructor has already been defined"),Oh=e}(gf),function(e){qr(!xh,"__referenceConstructor has already been defined"),xh=e}(gf);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const If={};let Ef=!1;function Cf(e,t,n,r,i){let s=r||e.options.databaseURL;void 0===s&&(e.options.projectId||Mc("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Ac("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,c=lf(s,i),l=c.repoInfo;void 0!==Ir&&Ir.env&&(a=Ir.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${l.namespace}`,c=lf(s,i),l=c.repoInfo):o=!c.repoInfo.secure;const u=i&&o?new Xc(Xc.OWNER):new Qc(e.name,e.options,t);Dd("Invalid Firebase Database URL",c),Tl(c.path)||Mc("Database URL must point to the root of a Firebase Database (not including a child path).");const h=function(e,t,n,r){let i=If[t.name];i||(i={},If[t.name]=i);let s=i[e.toURLString()];s&&Mc("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new jd(e,Ef,n,r),i[e.toURLString()]=s,s}(l,e,u,new Yc(e.name,n));return new Tf(h,e)}class Tf{get _repo(){return this._instanceStarted||(Wd(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new gf(this._repo,_l())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=If[t];n&&n[e.key]===e||Mc(`Database ${t}(${e.repoInfo_}) has already been deleted.`),Yd(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Mc("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}Al.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Al.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){wc="9.15.0",ps(new Li("database",((e,{instanceIdentifier:t})=>Cf(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ws("@firebase/database","0.14.0",e),ws("@firebase/database","0.14.0","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const Sf=ys({apiKey:"AIzaSyCDhc_FFOW788b9xS67xRCHGL2Falcnxko",authDomain:"filmoteks-fs61.firebaseapp.com",projectId:"filmoteks-fs61",storageBucket:"filmoteks-fs61.appspot.com",messagingSenderId:"392503967659",appId:"1:392503967659:web:7720f7b1803ed8583b9cee",measurementId:"G-JLEERBJV8V",databaseURL:"https://filmoteks-fs61-default-rtdb.europe-west1.firebasedatabase.app"}),kf=function(e=vs()){const t=gs(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=gs(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(bi(n.getOptions(),null!=t?t:{}))return e;Ms(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:pc,persistence:[Na,ma,ya]}),r=oi("authTokenSyncURL");if(r){const e=(i=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>mc)return;const r=null==t?void 0:t.token;_c!==r&&(_c=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(e,t,n){Ai(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,r){Ai(e).onIdTokenChanged(t,n,r)}(n,(t=>e(t)))}var i;const s=ii("auth");return s&&Uo(n,`http://${s}`),n}(Sf),Rf=function(e=vs(),t){const n=gs(e,"database").getImmediate({identifier:t}),r=si("database");return r&&function(e,t,n,r={}){(e=Ai(e))._checkNotDeleted("useEmulator"),e._instanceStarted&&Mc("Cannot call useEmulator() after instance has already been initialized.");const i=e._repoInternal;let s;if(i.repoInfo_.nodeAdmin)r.mockUserToken&&Mc('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),s=new Xc(Xc.OWNER);else if(r.mockUserToken){const t="string"==typeof r.mockUserToken?r.mockUserToken:ci(r.mockUserToken,e.app.options.projectId);s=new Xc(t)}!function(e,t,n,r){e.repoInfo_=new el(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams),r&&(e.authTokenProvider_=r)}(i,t,n,s)}(n,...r),n}(Sf),Pf=[{code:"auth/user-not-found",massage_ru:"Пользователь с такой почтой и паролем не найден",message_ua:"Користувача за цією поштою або паролем не знайдено ",message_en:"User with this password or email don'n found "},{code:"auth/network-request-failed",massage_ru:"Ошибка подключения . Проверьте наличие интернета.",message_ua:"Помилка підключення. Перевірте наявність інтернета",message_en:"Network error!"},{code:"auth/email-already-in-use",massage_ru:"Пользователь с такой почтой уже зарегистрирован!",message_ua:"Користувач з такую поштою вже в системі!",message_en:"This email already in use!"},{code:"auth/login",massage_ru:"Не авторизированные пользователи не могут пользоваться библиотекой",message_ua:"Не автризовані користувачи не можуть користуватися бібліотекою!",message_en:"Not auth users can't use library. Please  login!"},{code:"noData/available",message_ua:"Зараз тут пусто",message_ru:"Здесь сейчас пусто",message_en:"Now there is no films here"},{code:"films/place",message_ru:"Не правильно указан источник",message_ua:"Не правильно вказана папка ",message_en:"Invalid  folder"}],Nf={code:"default",message_ru:"Что-то пошло не так!",message_ua:"Упс Щось пішло не так!",message_en:"Oops. Something went wrong!"};function Of(e,t="en"){const n=Pf.find((({code:t})=>t===e));return n?n["message_"+t]:Nf["message_"+t]}var xf=new WeakSet;async function Af(){if(!this.refs)return!1;if(0===this.filmList.length){const e=await wf(yf(this.refs,"/"));if(e.exists()){const t=e.val();this.filmList=Object.values(t).map((({id:e,title:t,genres:n,year:r,poster_path:i,vote:s,place:o})=>{const a=new Jn({id:e,title:t,genres:n,year:r,poster_path:i,vote:s});return a.place=o,a}))}return this.isReadFilm=!0,!0}}const Lf=new class{setUid(e){e?(this.uid=e,this.refs=_f(this.db,"users/"+e)):(this.uid=null,this.refs=null,this.filmList=[]),this.isReadFilm=!1}async checkFilmInList(t,n){this.isReadFilm||await e(m)(this,xf,Af).call(this);for(let e=0;e<this.filmList.length;e+=1)if(this.filmList[e].id===t)return this.filmList[e].place=n,this.filmList[e];return null}async writeTo(e,t){if("QU"!=t&&"WA"!=t)return Of("films/place",this.language);if(!this.uid)return Of("auth/login",this.language);try{let n=await this.checkFilmInList(e.id,t);if(console.log("filmW:",n),!n){const{id:r,title:i,genres:s,release_date:o,poster_path:a,vote:c,language:l}=e;n=new Jn({id:r,title:i,genres:s,year:o,poster_path:a,vote:c,language:l}),n.place=t,this.filmList.push(n),console.log("writeTo this.filmList=",this.filmList)}return await vf(_f(this.db,"users/"+this.uid+"/"+n.id),n),""}catch(e){return Of(e.code,this.language)}}async getFilms(t){if("QU"!=t&&"WA"!=t)return Of("films/place",this.language);if(!this.refs)return Of("auth/login",this.language);try{this.isReadFilm||await e(m)(this,xf,Af).call(this)}catch(e){return Of(e.code,this.language)}return{films:this.filmList.filter((e=>e.place===t)),message:""}}constructor(t="en"){e(_)(this,xf),this.db=Rf,this.language=t,this.refs=null,this.filmList=[],this.uid=null,this.isReadFilm=!1}};const Df=new class{getUserDisplayName(){return this.isLogin?this.user.displayName&&this.user.displayName.length>0?this.user.displayName:this.user.email:""}getUserUid(){return this.isLogin?this.user?.uid:null}async login(e,t){try{const n=await da(kf,e,t);return this.user=n.user,""}catch(e){return Of(e.code,this.language)}}async logOut(){if(!this.isLogin)return"";try{return await kf.signOut(),""}catch(e){return Of(e.code,this.language)}}async singUp(e,t,n=""){try{const r=await ha(kf,e,t);return this.user=r.user,n.length,await fa(this.user,{displayName:n}),""}catch(e){return Of(e.code,this.language)}}constructor(e,t="en"){this.user=e,this.isLogin=!!e,this.language=t}}(null);kf.onAuthStateChanged((e=>{e?(Df.user=e,Df.isLogin=!0,Lf.setUid(e.uid)):(Df.user=null,Df.isLogin=!1,Lf.setUid(null)),vc(Df.isLogin,Df.getUserDisplayName())}));const Mf=Qn();Mf.modeButton.addEventListener("click",(function(){document.body.classList.contains("moon")?(document.body.classList.remove("moon"),Mf.moon.classList.add("visually-hidden"),Mf.sun.classList.remove("visually-hidden"),localStorage.setItem("mode",!1)):(document.body.classList.add("moon"),localStorage.setItem("mode","moon"),Mf.sun.classList.add("visually-hidden"),Mf.moon.classList.remove("visually-hidden"))})),"moon"===localStorage.getItem("mode")&&(document.body.classList.add("moon"),Mf.sun.classList.add("visually-hidden"),Mf.moon.classList.remove("visually-hidden"));
//# sourceMappingURL=index.734d95c1.js.map
